...
ultima_execucao: 2026-09-13T14:10Z
executando_desde: 2026-09-13T15:18Z
bloco_atual: "'MEUS DADOS' — A ABA ONDE ELA MANDA NO QUE SO EXISTIA EM CODIGO (atelie 1.2.0, leads 1.1.0, manifest revisao 22, /status conferido as 14h04Z; nenhuma URL nova). Fecha o ultimo pedaco do adendo 3 que tinha ficado por fazer e cumpre a linha do PROMPT.md que promete desde 10/09 que ela troca a senha em Meus dados dentro do painel. TRES SECOES: 'Seu acesso' mostra o e-mail da conta COMO TEXTO, 'Sua senha' troca a senha, e 'Avisos de interessados' — que NAO e do arquivo do Atelie — traz cdm_email_leads e cdm_artesa_nome. AS QUATRO DECISOES: (1) A TROCA DE SENHA NAO PEDE A SENHA ATUAL, e e escolha: o WordPress nao pede na tela de perfil dele, e aqui a razao e mais forte — ELA ENTROU POR UM LINK DE E-MAIL e pode legitimamente nao saber a senha que quer trocar, entao pedi-la trancaria a porta para quem tem a chave. Protege a acao o par de sempre, sessao + nonce, e quem ja esta dentro da sessao dela ja podia publicar, apagar e exportar os interessados. Se um dia houver mais de uma pessoa no atelie, a linha se reabre. (2) O E-MAIL DA CONTA APARECE E NAO SE EDITA: e para onde vai o link de recuperar senha, e um dedo errado no teclado do celular a deixaria de fora da propria conta sem ninguem para socorrer no domingo; o portao mede as duas metades, que ele APARECE e que NAO existe input com ele. (3) QUEM LE A OPTION E QUEM A ESCREVE — as duas sao lidas so pelo snippet de Leads, entao os campos nascem la e chegam pelo filtro novo cdm_atelie_meus_dados, do mesmo jeito e pela mesma razao que a aba Interessados chega pelo cdm_atelie_abas: o Sync desembarca um snippet sem o outro. Cada secao e um FORMULARIO PROPRIO, com nonce e gravacao proprios, e a borda do cartao diz onde um acaba e o outro comeca. (4) A ABA EXISTE MESMO SEM O SNIPPET DE LEADS, entao a navegacao passa a aparecer sempre — sao tres abas agora. O VAZIO CONTINUA SIGNIFICANDO O QUE SIGNIFICAVA e agora a TELA DIZ ISSO: e-mail em branco volta ao endereco padrao, nome em branco volta a assinar 'do Clube do Mosaico', branco GRAVA branco (senao ela nao desfaz um endereco digitado por engano), e e-mail INVALIDO nao derruba o que funcionava, porque trocar um endereco que recebe por um que nao existe e o aviso do interessado sumindo sem ninguem perceber. A GUARDA DE defined() no snippet de Leads e a ordem do desembarque: ele pode chegar minutos antes do Atelie 1.2.0, que declara CDM_ATELIE_ABA_DADOS, e sem ela um POST daquela acao seria erro fatal no lugar da tela. A BANCADA GANHOU O MUNDO SEM O DONO (sem_leads=1, na familia do sem_links de 13/09): 'a tela nao promete o que o dono ausente nao entrega' so pode ser medido com o dono AUSENTE, e nao ha como produzir isso lendo codigo. DUAS MUTACOES PASSARAM NA PRIMEIRA PASSADA e as duas eram buraco de PORTAO: (34) todas as afirmacoes da aba rodavam COM A ARTESA LOGADA, entao nenhuma via a guarda de sessao cair — portao que so mede o caminho feliz da recusa mede a recusa errada; (48) a regua cobrava o endereco na tela COM A OPTION VAZIA, e ai 'hoje' e 'o padrao' sao o mesmo texto — regua que so distingue quando os dois valores diferem tem de ser medida onde eles diferem. E UMA MUTACAO ANTIGA TINHA VIRADO INERTE (24): o alvo dela era 'o que vem antes do add_shortcode' e a versao nova pos duas funcoes no meio. Alvo que depende da vizinhanca morre quando o vizinho se muda, e inerte conta como passou. VERIFICACAO NA BANCADA, 0 falha: teste-atelie 251 (era 209), teste-leads 211 (era 184), teste-casca 546, teste-loja 147, teste-f1 70, teste-f2 74, prestacao-rejunte 5 sobre 720 estados, conferir-cobertura 128, validar-banco APROVADO, php -l em tudo. NAVEGADOR: 128 medicoes em 8 paginas x 5 larguras, 0 px de rolagem — a tela nova passou de primeira no alvo de toque e na fonte de 16 px porque reusa .cdm-at-campo e .cdm-at-botao. MUTACOES: 262 em 12 baterias, 262 reprovadas, 0 passaram, 0 inertes. NO AR as 14h04Z: /status na revisao 22 igual a do manifest, 10 aplicados; conferir-no-ar 339 e conferir-atelie-no-ar 45 (era 37), 0 falha; as sete capacidades continuam sendo sete; e a marca do codigo novo medida NO CORPO SERVIDO (.cdm-at-secao so existe no 1.2.0), que e a diferenca entre 'o manifest diz que subiu' e 'o site esta servindo'. O ACHADO QUE NAO ERA DESTE BLOCO E CUSTOU MAIS QUE ELE: os commits 4e69738 e 35412c1 editaram os dois bancos desta ilha SEM tocar no manifest, e o /status recusou aplicar em tres revisoes seguidas — os dez links novos, o url_produto e as tres fotos estavam no repositorio e FORA DO AR, a secao 4 na forma mais pura, pela segunda vez no mesmo dia. O 4e69738 deixou tambem 11 erros de esquema (mercado_livre onde o vocabulario diz mercadolivre — o MESMO defeito de 12/09 —, imagem sem largura/altura, contadores de cabecalho mentindo 'nenhuma foto foi coletada' com tres coletadas). A LARGURA E A ALTURA TINHAM DOIS CAMINHOS e o comodo era o errado: afrouxar o esquema pareceria razoavel e nao e, porque os dois campos existem para a pagina RESERVAR A CAIXA da foto antes de ela chegar, e caixa sem medida e o salto de layout da 22.4. O outro caminho era MEDIR — cf.shopee.com.br responde 200 em duas passadas — e nasceu ferramentas/medir-imagens.py, que le a dimensao do cabecalho do arquivo servido (JPEG, PNG, WebP, sem biblioteca): 1024x1024, 1024x1024 e 768x768, LIDAS. 800x800 digitado porque foto de e-commerce costuma ser quadrada passaria no validador igual. E A METADE QUE E DO RAPHAEL esta em dados/despachos.md: a reserva por commit funcionou como escrito e uma TERCEIRA sessao editou o banco desta ilha assim mesmo — a reserva protege contra quem a le, nao contra quem entra pela porta do dado. ABERTO E NOMEADO: (a) o url_busca do degrau 3 e o segundo link discreto que a 25.2 manda por embaixo do botao chegaram ao BANCO e a pagina ainda NAO os serve — a escada existe no dado e nao na tela; (b) a ilha nao tem peca publicada, entao ficha, formulario no ar e feed do Merchant Center continuam esperando ela; (c) o contato@clubedomosaico.com.br ainda nao existe como caixa, e o caminho do remetente fica gravado no lead. PROXIMO, com ordem e motivo: (1) a ordem de BANCO ja escrita — fechar 2x2 na categoria pastilha, que esta a UM item dos 3 da 14.3, depois a vitrine de pastilha da F1, depois a categoria cola; (2) servir o url_busca na pagina, que e o item (a) acima e e curto; (3) o feed do Merchant Center, que e espera e nao escolha de fila. O que so um humano fecha continua o mesmo: confirmar que o e-mail de acesso CHEGOU na caixa da Hotmail."
