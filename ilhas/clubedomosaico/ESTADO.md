...
executando_desde: 2026-09-14T17:53Z
bloco_atual: |
  ...
  O DEFEITO: ate a 1.2.0 o bloco do REJUNTE vinha antes do da PASTILHA. Nao era decisao, era heranca de quando o lugar da pastilha era uma frase de espera e o rejunte era o unico bloco de compra da pagina; a 1.2.0 encheu o lugar com treze produtos e manteve a sequencia de chamada. Nao havia regua nenhuma sobre ordem, e ordem que ninguem mede nao pode nem ser corrigida com confianca. A pastilha vem primeiro porque o title, o H1 e a primeira frase de resposta desta pagina falam dela (secao 22.1 e o 'produto primeiro' do VOZ.md). Nada da 22.2 se moveu: resposta antes da explicacao, os DOIS blocos de compra antes da camada de prova (secao 7), nenhuma URL, trilha, ancora ou JSON-LD mudou.
  O QUE A TROCA REVELOU: o titulo era 'E onde comprar a pastilha'. Aquele 'E' e conector, so verdadeiro em segundo lugar, e titulo e a frase que um modelo de linguagem cita sozinho (secao 5). Os dois titulos passaram a ser autossuficientes ('Onde comprar a pastilha' e 'Qual rejunte cabe nessa folga').
  A FRONTEIRA GANHOU NOME (cicatriz da Robometria de 13/09): a bancada e o conferir-no-ar extraiam cada vitrine pelo TEXTO do H2, que muda e que na saida degradada do rejunte NUNCA extraiu nada. Cada vitrine passou a declarar a propria classe (cdm-f1-vitrine-pastilha, cdm-f1-vitrine-rejunte) em TODAS as saidas, e as tres reguas leem o marcador.
  O MUNDO SEM A F2 FOI PRODUZIDO PELA PRIMEIRA VEZ: a F1 chama a regua do rejunte da F2, e tem duas saidas degradadas que existiam desde 12/09 sem uma afirmacao encostando nelas. O render ganhou sem_f2=1 e a bancada mede esse mundo: a conta continua, as duas vitrines dizem que a lista esta fora do ar, e nenhum produto ou recusa e improvisado.
  PORTAO VERMELHO QUE JA ESTAVA NO MAIN: validar-banco reprovava o dados/pecas.json que a execucao das 11h18Z criou (a copia da secao 24 da primeira peca de verdade). A regua era de 12/09 e proibia o arquivo de existir, verdadeira antes de a secao 24 entrar no contrato e mandar a copia nascer. Trocada: o que ela protege nao e a ausencia do arquivo, e que ele seja COPIA e nunca FONTE. Tres afirmacoes, a do meio a de verdade: publicar false no manifest; NENHUM snippet le o arquivo nem a option que ele teria (medido no codigo que vai ao ar, sem comentario); e a forma da resposta do endpoint (id de post, url do dominio, total que bate com a lista, sem gerado_em). Quatro mutacoes novas na bateria do rejunte.
  VERIFICACAO, BANCADA, 0 falha: teste-f1 211 (era 190, nasceu a secao 4d), mutacoes-f1 46 de 46 (seis novas), teste-prestacao-rejunte 5 sobre 540 e 180 estados, validar-banco aprovado 25 materiais e 45 celulas, mutacoes-rejunte 16 de 16 (quatro novas), validar-pastilhas 189, mutacoes-prestacao 11 de 11, mutacoes-cobertura 11 de 11, teste-casca 549, teste-f2 107, teste-loja 178, teste-atelie aprovado, teste-leads 211, conferir-cobertura 353, php -l limpo.
  NO AR: /status na revisao 31 igual a do manifest, em UM disparo com 10 aplicados. A F1 serve a vitrine da pastilha ANTES da do rejunte, com os marcadores cdm-f1-vitrine-pastilha e cdm-f1-vitrine-rejunte e os titulos Onde comprar a pastilha e Qual rejunte cabe nessa folga (nenhum com conector). conferir-no-ar 437 afirmacoes (eram 416), 0 falha.
  RECEITA, e nada mudou neste bloco: 7 colas, 25 itens de fabricante, 15 esperando link, 15 sem piso, 22 sem imagem; os 15 url_busca seguem dependendo de UMA sessao do painel da Shopee. Pauta da secao 17: pauta.md ainda nao existe.
  ABERTO E NOMEADO: (a) a familia /tecnicas/<slug>/ NAO nasceu, e nao e esquecimento — NENHUMA tecnica desta ilha tem pagina (as duas taxonomias sao public false por orcamento de rastreamento), e criar uma sozinha abriria a familia por uma porta lateral: e bloco de malha; (b) a metade humana do item 4 da galeria continua aberta (o dedo dela na tela, num telefone); (c) os 15 url_busca dependem da sessao da Shopee; (d) o egresso a fabricante segue fechado e a ficha BRSA005 nao lida; (e) 1x1 de fabricante com zero elegivel, 7 das 12 linhas da tabela da F1; (f) contato@clubedomosaico.com.br ainda nao existe como caixa; (g) a divida de modelagem do campo tecnica (METODO x ESTILO), mandada NAO mexer agora.
  PROXIMO, com ordem e motivo: (1) a familia /tecnicas/<slug>/, decisao de malha com o orcamento de rastreamento na mesa e agora com peca publicada para linkar; (2) 1x1 DE FABRICANTE, a pendencia mais cara da categoria pastilha, que sozinha muda 7 das 12 linhas da tabela da F1; (3) a categoria COLA, 45 estados varridos e 0 com o minimo da 14.3; (4) os 15 url_busca, no minuto em que houver sessao.
