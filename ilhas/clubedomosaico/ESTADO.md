...
ultima_execucao: 2026-09-12T15:56Z
executando_desde: 2026-09-12T17:19Z
bloco_atual: "DESPACHO DA SENTINELA DE 12/09 CUMPRIDO INTEIRO — os dois itens, com o criterio deles medido no HTML SERVIDO (F1 1.1.0, F2 1.1.0, manifest revisao 12, /status com revisao 12 as 15h51Z, em UM disparo). OS DOIS ITENS ERAM O MESMO DEFEITO COM DUAS ROUPAS: a pagina falava de menos produtos do que listava, ou nomeava a causa errada por quem ficou de fora. Por isso o conserto virou UMA regra e subiu para o ARQUIPELAGO.md secao 7, valendo para toda ilha: todo item do banco e nomeado exatamente uma vez em cada resposta — na frase que o recomenda, e ai ele esta na vitrine, ou numa linha que diz por que ele nao esta — e o bloco de compra serve exatamente o que a frase nomeia; com a metade complementar, que e a recusa nomear a causa MEDIDA em vez de oferecer hipotese, e afirmacao em bloco ter o escopo do que foi medido. ITEM 2 (F2): a frase dizia 'o rejunte e Rejunte Acrilico Quartzolit', singular e definitiva, e a vitrine servia QUATRO cartoes; agora a frase tem duas linhas (a recomendacao e os que TAMBEM servem, com o que os separa escrito: o fabricante nao nomeia o lugar, e a regua do rejunte so transforma silencio em exclusao nos ambientes criticos) e a vitrine serve exatamente esses. DOIS ACHADOS QUE NAO ESTAVAM NO DESPACHO: o grupo mencionados_com_ressalva nao era impresso em lugar nenhum — vazio com o banco de hoje, invisivel para sempre no dia em que enchesse; e 'faixa nao obtida' estava sendo contada como 'a folga nao cabe', que e afirmar sobre uma declaracao que ninguem leu (o rejunte piscinas nao publica faixa e a pagina dizia que ele nao cobria 2 mm). Esse segundo tinha tornado INALCANCAVEL um ramo da frase de recusa escrito no proprio conserto ('so o lugar exclui'): com o piscinas eternamente no balde da folga, aquele caso nunca acontece — ramo morto saiu, quem diz a causa sao as linhas. ITEM 1 (F1): a recusa culpava SEMPRE a folga, inclusive quando a folga cabia e quem excluia era o lugar, e com a linha de outro tipo logo abaixo dizendo 'dentro dessa folga' a pagina negava e afirmava o mesmo fato em duas frases seguidas; agora sao tres causas com nome proprio, produtos nomeados e a faixa que o fabricante publica, e quando a causa e o lugar a pagina diz 'e o LUGAR, nao a folga' — o que nao e suposicao, porque quem cai pelo lugar passou pela trava da folga antes. A OUTRA METADE DO DEFEITO SO A TELA MOSTRAVA: strtok( $rotulo, ' —' ) cortava no primeiro espaco e devolvia so 'Rejunte', entao a frase afirmava sobre o banco INTEIRO o que valia no maximo para o tipo escolhido. O PORTAO ACHOU UM BURACO NO PROPRIO CONSERTO, antes do desembarque: a primeira versao da F1 so prestava contas quando a lista voltava vazia, e em 27 estados ela listava dois cimenticios sem dizer uma palavra sobre o terceiro — o item 2 um andar acima. PORTAO NOVO teste-prestacao-rejunte.php, com regua propria recomputada dos perfis escritos a mao e das regras 1 a 4 do esquema (nada nele chama cdm_f2_celula_rejunte, cdm_f2_avaliar_rejunte nem cdm_f2_perfil_rejunte), varrendo 540 estados da F2, 180 da F1 e as 9 linhas da tabela pre-renderizada, um processo por estado, com as folgas de 1 a 12 para pisar nas bordas. mutacoes-prestacao.py 11 de 11 reprovadas, e QUATRO delas nao morderam na primeira rodada, cada uma ensinando coisa diferente: a que mirava fora_lugar apontava para um estado que o banco de hoje nao produz; a do grupo de ressalva precisou PRODUZIR O MUNDO nas duas metades (o nivel nas fontes do banco, que o snippet le, e o nivel no perfil escrito a mao, que a regua le); a da tabela mirava grupo vazio; e a da promocao silenciosa PASSOU POR ERRO DE ALVO, porque a linha do score e identica byte a byte em cdm_f2_avaliar_cola e em cdm_f2_avaliar_rejunte e a substituicao pegou a primeira — mutou a cola, que este portao nao mede, e o verde foi honesto. DOIS DEFEITOS MECANICOS NA MESMA PASSADA (secao 19): o manifest declara sha256 no grupo ferramentas desde que nasceu e NENHUMA linha o recalculava (render-para-teste e teste-casca estavam com etiqueta de versao que nao existe mais), e a lista conhecia 9 das 18 ferramentas do disco — entre as ausentes, teste-f1.php e teste-f2.php, os dois portoes principais da ilha; atualizar-manifest.py passou a espelhar o grupo e a cobrar as duas direcoes, 16 sha recalculados. UMA AFIRMACAO ANTIGA FOI REESCRITA e isso e parte da entrega: teste-f1.php cobrava a string 'do nosso banco declara folga' para 11 e 12 mm, que e a frase DO DEFEITO — afirmacao que fixa o texto de hoje vira trava contra o conserto de amanha, e ela passou a cobrar a intencao. VERIFICACAO: php -l limpo nos tres; teste-prestacao-rejunte 5 afirmacoes 0 falha em 729 estados; teste-f1 67; teste-f2 72; teste-casca 409; validar-banco sem regressao; mutacoes antigas intactas (f1 27/27, f2 20/20, rejunte 12/12, arvore 20/20, nenhuma virou inerte); Chromium em 360/390/781/782/783/1200 nas 16 paginas renderizadas, 98 medicoes, 0 px de rolagem. NO AR: conferir-no-ar.py mediu 231 afirmacoes no HTML SERVIDO, 0 falha, e ganhou as afirmacoes do despacho escritas nas palavras do proprio despacho — as 6 combinacoes do item 1 sem a frase antiga, dizendo que a exclusao e do lugar e nomeando o lugar; os 5 rejuntes contados um a um em 3 respostas do item 2; e as 9 linhas da tabela somando 5. 10 dos 10 itens do banco esperam link de afiliado e 10 estao sem imagem; este bloco nao tocou catalogo e nenhum dos dez tem loja possivel hoje. Pauta da secao 17: pauta.md ainda nao existe — 0 escritos, 0 na fila, 0 recusados. PROXIMO: o bloco 4c, fichas de categoria de material. A regra nova da secao 7 nasce com ele em vez de ser descoberta depois, porque ficha de categoria e por definicao uma pagina que fala de TODOS os itens de uma categoria do banco — a prestacao de contas dela e a propria pagina, e o portao desta execucao ja sabe medir isso. A ilha esta ABAIXO DO PISO da secao 21 (11 URLs, 21 dias nao passaram), entao a leva sai no ritmo normal, de 5 a 10 URLs, sem esperar medicao."
