 ...
 *
 * O QUE FOI MEDIDO AQUI, e a parte que vale para TODA ilha: **a purga só passa
 * a valer no SEGUNDO Sync.** A casca que a contém faz parte da carga que está
 * sendo entregue — no Sync que a instala, o PHP já carregado é o anterior, e
 * nenhuma purga roda. Minuto a minuto, em 14/09/2026: às 17h40Z, antes do
 * bloco, as 11 URLs do sitemap serviam a assinatura do Endurance e o canônico
 * concordava com a quebra de cache; às 18h29 o Sync da revisão 32 aplicou com a
 * 1.9.2 na memória e o canônico passou a servir cópia velha — a home com uma
 * entrada de **13h53Z**, do bloco anterior, velha havia cinco horas sem ninguém
 * ver; às 18h34 um segundo Sync, já com esta versão carregada; poucos minutos
 * depois o canônico servia o bloco novo nas onze URLs, com **zero** ocorrência
 * da frase proibida. São duas camadas, e os cabeçalhos as nomeiam:
