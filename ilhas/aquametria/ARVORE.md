...
| `/peixes/vivaparos/` | — | em breve — **2 elegíveis** (platy e espada). Guppy e molly estão a um campo cada: o guppy tem duas urls de um corpo só (E15, espelho não confere espelho) e o molly não tem `comprimento_minimo_aquario_cm`. **Coleta de 13/09/2026, os dois recusados:** o molly teve `90 × 30 × 30 cm` devolvido por UMA passada e por nenhuma das outras três que não o carregavam na consulta — e uma passada não é confirmação, pela mesma régua que sustentou o gurami mel; o guppy esbarrou na parede de sempre, e a saída dele continua sendo a leitura direta da ficha ou um terceiro corpo. Esta é a categoria mais barata do banco: com os dois, ela vai de 2 para 4 |
