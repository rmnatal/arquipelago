...
- PRÓXIMO: BLOCO 4 — rascunhos dos artigos-âncora (12 a 15 textos; cada tabela técnica cita o manual do fabricante e leva data de verificação). A tabela de turnover por fabricante e a série W/L da Roxin já são dois artigos com dado próprio. Coletas baratas para fazer junto: voltagem dos 9 equipamentos, `coluna_maxima_m` do SunSun HW-303B e do Seachem Tidal 55, `volume_filtragem_L` dos canisters, `faixa_ajuste_C` da Roxin na embalagem.
