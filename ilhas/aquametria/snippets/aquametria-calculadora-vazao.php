...
function aquametria_c3_catalogo() {
	...
	return array(
		...
		array(
			...
			'anuncio' => null,
			'loja' => null,
			'observacao' => 'O caso que justificou o campo variante: uma letra a mais no modelo muda vazao (1200 para 1500 L/h), potencia (35 para 18 W), coluna (1,8 para 1,5 m) e volume atendido (ate 450 para 150 a 400 L). Sao dois produtos, nunca um. Turnover implicito de 3,8 (no teto) a 10,0 (no piso) renovacoes/h.',
		),
	);
	/* CATALOGO-FIM */
}
...
function aquametria_c3_shortcode() {
	...
	$h  = '<div class="aqm-c3">';
	$h .= '<style id="aquametria-c3-estilo">' . aquametria_c3_css() . '</style>';
	...
	$h .= '<script id="aquametria-c3-script">' . $js . '</script>';
	$h .= '</div>';
