...
DESDE 10/09/2026 (bloco T8, a vitrine da C5) o item embutido leva mais dois
campos, com o mesmo desenho do gerador dos filtros — de proposito, porque duas
regras diferentes para o mesmo cartao viram duas telas diferentes:
...
def main():
    ...
    for item in catalogo:
        preco = item["preco"]
        print("  %-28s %4s W  ajuste %s a %s C%s  link: %-3s foto: %-3s cotacao: %s"
