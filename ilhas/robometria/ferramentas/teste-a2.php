...
foreach ( $__doc_datas['registros'] as $__r ) {
	if ( ROBOMETRIA_A2_SLUG === $__r['slug'] ) { $__pag_datas = $__r; }
}
rbm_ok( ! empty( $__pag_datas ), 'a pagina tem registro em datas-das-paginas.json', ROBOMETRIA_A2_SLUG );

$__ld = array();
if ( preg_match( '#<script type="application/ld\\+json" id="robometria-a2-jsonld">(.*?)</script>#s', $pagina, $__m ) ) {
