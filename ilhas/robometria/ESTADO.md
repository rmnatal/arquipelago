...
bloco_atual: |
  ...
  MODELO NOVO SOBE A INTERSECAO E O TETO NO MESMO MOVIMENTO, e peca nova nunca faz isso — era exatamente o que a execucao das 13h16Z deixou escrito como proximo passo, e funcionou na primeira tentativa. O canal continua sendo a BUSCA restrita ao dominio do fabricante: o egresso direto a www.mi.com devolveu EGRESS_BLOCKED nesta execucao, com a ilha em 200 na mesma janela.
  A ESCOVA PRINCIPAL NASCEU POR CONTRASTE NO CATALOGO (26.1, origem 2) — PRIMEIRA vez nesta ilha que o contraste vem publicado DUAS vezes no mesmo modelo: 'brush' ao lado de 'side brush' na lista de consumiveis do KA-11405, e o par repetido no conteudo da caixa da pagina de especificacoes. O 'main brush' do KA-11406 e de OUTRO modelo e NAO foi emprestado, porque contraste emprestado e heranca — e o proprio artigo declara que os consumiveis deste modelo nao sao compativeis com os dos outros. Lido no ar: 'Quem chama esta peca de escova principal e a Robometria, pelo contraste do catalogo do proprio fabricante'.
  TRES MUTACOES ESTAVAM INERTES NO MAIN E NINGUEM TINHA VISTO. mutacoes-arvore: o troca_n do reservatorio declarava 3 e o banco tinha 4 desde a leva das 13h16Z — a PARADA nao foi lida, e o registro daquela execucao fechou dizendo '25 baterias, todas com o resultado esperado e ZERO inertes'. mutacoes-cabeca-e-voz: duas mutacoes com alvo de ZERO ocorrencia desde a proposta 2 das 10h32Z, que reescreveu a description da R2 em molde e trocou a forma da guarda. Os portoes estavam inteiros nos tres casos; o que morreu foi a PROVA de que eles mordem. As tres reapontadas, e as 25 baterias voltam a 100% com zero inertes.
  DIVIDA NOMEADA, NAO DETALHE: vida_util_declarada guarda UM numero e as duas coletas Xiaomi desta ilha declararam INTERVALO — o Mop 2 em horas de uso e o Mop 2 Lite em faixa de meses ('3-6 months', '6-12 months'). Os cinco registros ficaram com valor null e a citacao literal no motivo_do_null, que vai para a tela com as palavras do fabricante. O campo nao comporta faixa, e isso ja foi medido de dois jeitos diferentes.
  O QUE A VARREDURA MEDIU E NAO ENTROU: o Mi Robot Vacuum-Mop (original) tem canal brasileiro e artigo proprio, mas o Pa veio em UMA passada e qualificado por variante ('for the Visual Navigation Version'); X10, X20 e E5 nao foram confirmados em mi.com/br em duas passadas. O canal brasileiro da Xiaomi esta varrido inteiro: o proximo modelo com os tres campos vem de outra marca.
  BANCADA 0 falha: casca 251, r1 227, a1 74, r2 107, a2 80, acentuacao 17, arvore 219, voz 164, escada-compra 801, validar-banco aprovado. MUTACOES: as 25 baterias, todas com o resultado esperado e ZERO inertes — conferido varrendo a saida inteira por 'ERRO' e por 'PASSARAM', nao a ultima linha. NO AR: Sync as 16h32Z, /status na revisao 62 igual a do manifest; conferir-no-ar 264, conferir-kits-no-ar 165, conferir-reservatorio-no-ar 50, conferir-atribuicao-no-ar 51 e conferir-canal-na-resposta, todos 0 falha. A consulta Mop 2 Lite + escova principal foi aberta na tela e responde com a atribuicao da 26.3 correta.
