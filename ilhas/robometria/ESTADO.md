...
executando_desde: 2026-09-16T19:53Z
bloco_atual: |
  ...
  DESPACHO 1 — O ESPACO VAZIO DA FOTO ERA UM SPINNER. border-radius 50 por cento com um lado transparente e a forma universal da roda de carregamento: quem chegava lia 'a foto esta carregando' e, como ela nunca carrega, lia 'este site esta quebrado'. Uma regra de CSS na casca conserta as quatro ferramentas. E a edicao 2 era o defeito que so apareceria depois: R2 e A2 emitiam o painel SEMPRE, e so nao se via porque nenhum registro tinha foto — VERDADE POR COINCIDENCIA DO BANCO, e o despacho seguinte, no mesmo dia, era justamente o que traria a primeira foto.
  DESPACHO 2 — A OPEN API DA SHOPEE, os quatro itens. shopee-api.py na raiz (como ga4.py, porque a 25.6 nasce valendo para todas as ilhas); o esquema ganhou o portao que faltava no bloco imagem; a coleta; a vitrine com foto.
  A COLETA: 27 de 73 publicaveis casaram — 12 pecas, 15 modelos. Degraus da escada de palavra-chave: 12 no 1 (codigo sozinho), 3 no 2, 8 no 3, 4 no 4. OS 46 QUE NAO CASARAM FICARAM SEM FOTO E SEM FICHA, COM O MOTIVO ESCRITO. Isso e medicao honesta, nao falha.
  E A CONFERENCIA COM OS OLHOS DA 25.3 PAGOU POR SI CINCO VEZES, cada uma um casamento que a regra do despacho aprovaria: 'Tampa Do Filtro' casando com um filtro; 'Kit Filtro Pinos e Lamina' casando com um filtro; S10, E10, W100 e S40 sozinhos casando com mangueira de ar-condicionado, mascara capilar, whey protein e fechadura de Volvo, e 'Carcaca Inferior', 'Placa de Potencia' e 'Controle Remoto' casando como se fossem o ERB10, o ERB11 e o ERB20; S40 casando com 'S40 PRO' e com 'S40 C', e S10 com 'S10+'; e dois registros do banco no mesmo anuncio. As cinco viraram a secao 25.7 do contrato.
  LARGURA E ALTURA SAO MEDIDAS, NAO SUPOSTAS. A API nao devolve dimensao, mas cf.shopee.com.br responde 200 daqui: a ferramenta le os primeiros bytes e parseia o cabecalho JPEG/PNG/WebP. 27 de 27 medidas. Sem as duas a foto nao entra — salto de layout e pior que sem foto.
  SETE REGUAS AMARRADAS A UM DEGRAU CAIRAM NO MESMO DIA, e essa e a licao maior. De manha quatro reprovaram a chegada dos links encurtados; corrigidas para cobrar rbm-comprar-busca, AS MESMAS CAIRAM DE NOVO a tarde quando a ficha chegou e os cartoes subiram outro degrau. Com elas cairam a secao 11 do conferir-no-ar e o conferir-reservatorio-no-ar, este porque o ROTULO DO BOTAO muda com o degrau. Trocar a classe por outra so adia a proxima queda: todas passaram a contar CARTAO contra BLOCO DE COMPRA. Subiu para a secao 8.
  E TRES TRAVAS ESTAVAM DOENTES. itens_com_ficha contava o LINK DE AFILIADO e se chamava ficha, nos dois bancos e na bateria da escada — as duas copias erradas juntas, dando zero, entao ninguem podia ver. mutacoes-escada tinha uma mutacao INERTE, apagando um motivo que ja estava vazio desde que os modelos ganharam piso. E conferir-kits-no-ar esperava que E10 x escova lateral RECUSASSE, verdade ate 14/09: ficou VERMELHO sobre uma pagina certa e ninguem viu porque ninguem o rodou desde a leva.
  BANCADA, 0 falha: casca 219, r1 224, r2 107, a1 68, a2 74, arvore 219, voz 155, acentuacao 17, purga-cache 21, escada-compra 721, validar-banco e conferir-canal-na-resposta aprovados, php -l limpo nos seis snippets. MUTACOES: 23 baterias, todas no resultado esperado, ZERO inertes.
  NO AR: Sync em dois disparos nas duas revisoes, /status na revisao do manifest, conferir-no-ar 251 afirmacoes, conferir-kits-no-ar 165, conferir-reservatorio-no-ar 50, conferir-atribuicao-no-ar 42 — todos 0 falha.
  CREDENCIAL: veio do documento privado do Drive, passou ao processo so como variavel de ambiente, e NAO esta em arquivo, log, relatorio nem mensagem de commit — conferido com grep na arvore inteira antes de cada push.
  UMA COISA SAIU TORTA: o commit 82c2e54 perdeu os trechos entre crases da mensagem, porque ela foi passada com -m e o bash expandiu as crases. O conteudo esta certo, a mensagem esta furada, e nao ha conserto sem reescrever historico ja empurrado — o que esta fabrica proibe. Mensagem longa passa a ir por arquivo, com -F.
  O PROXIMO PASSO, MEDIDO E NAO LEMBRADO: o item 2 da DEFINICAO DE PRONTA NAO ANDOU, E A API NAO O RESOLVE. Ela trouxe foto, ficha e link; a intersecao das duas ferramentas conta pa_declarado E canal_brasileiro, e nenhum dos dois veio da Shopee. Segue 8 de 38, e o 8 continua honesto. Os tres caminhos: (1) POSITIVO e o unico que mexe nos dois lados — positivo-pra500 esta em 'so a R2' esperando UMA peca, e PRA100, PRA600 e PRA90 apareceram fora do banco; ATENCAO, as duas passadas de busca DIVERGIRAM sobre o Pa do PRA800 e do PRA2000 (2.300/2.800 contra 2.800/3.000), entao a coleta tem de resolver pela regra de divergencia antes de gravar. (2) WAP medida NEGATIVA para Pa. (3) Electrolux e Multi sem Pa em canal nenhum, ja medido tres vezes.
  E UM ALVO NOVO QUE ESTA EXECUCAO ABRIU: com item_id_shopee e shop_id_shopee no banco, O TESTE DE VIDA DA 25.4-b PASSA A SER POSSIVEL NESTA ILHA — 27 links tem ficha, e a API de ficha da Shopee aceita o par. Era o que o item 5 do despacho de 14/09 dizia nao existir aqui.
