...
Nada. A falta de WordPress **não** é bloqueio: os blocos 1 (buscas
paramétricas), 2 (especificação das ferramentas) e 3 (modelo do banco) são de
pesquisa e modelagem e rodam sem infraestrutura. Por isso `bloqueada_por`
continua `null`.
