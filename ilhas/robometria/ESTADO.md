...
bloco_atual: |
  ...
  O DEFEITO QUE O BLOCO EXISTIA PARA ACHAR, e ele estava na elegibilidade da ferramenta que recomenda COMPRA. A R2 pedia status publicavel e pa_declarado e NADA perguntava se o leitor consegue comprar o aparelho no Brasil. A lista saia certa mesmo assim porque as cinco marcas coletadas eram todas de canal brasileiro: VERDADE POR COINCIDENCIA DA COLETA, a mesma familia dos dois 63 da R1 e da funcao morta do snippet. E o contraexemplo ja estava DENTRO do banco desde 13/09 — cinco codigos Xiaomi (E10C, E12, S12, S40 Pro, X20) declarados pelas paginas de acessorio do proprio fabricante, ausentes da linha da Xiaomi Brasil, um deles com 15.000 Pa. Sem portao, o primeiro nome da lista em toda situacao de pelo seria um aparelho que o leitor nao compra aqui.
  O QUE NASCEU: canal_brasileiro como campo de primeira classe; tem_canal_brasileiro() e recomendaveis() na referencia; o grupo sem_canal_brasileiro NOMEADO na resposta servida e nao subtraido em silencio; tres contagens e a invariante de que o canal e pagina do FABRICANTE (marketplace aprovaria os 38, porque todo codigo tem busca em marketplace); conferir-canal-na-resposta.py, que le o ARTEFATO PUBLICADO e nao o codigo que o gerou; e mutacoes-canal-brasileiro.py com 5 de 5 reprovadas. A bateria e obrigatoria aqui: o portao NAO mudou uma linha da tela, e trava que nasce sem mudar nada e trava que ninguem sabe se existe.
  A REGUA DA META MUDOU JUNTO, e essa e a metade que protege o prazo. O item 2 da definicao de pronta e um numero sobre o cruzamento das duas ferramentas, e ele contava 'a R2 responde' como 'tem Pa'. Os cinco Xiaomi contariam +5 na intersecao sem que UMA pessoa a mais fosse atendida — a forma mais barata de fechar a meta seria despejar modelos globais no banco. Regua que mede a meta nao pode ser mais frouxa que a ferramenta que a meta descreve, senao a meta se fecha sozinha. Intersecao segue 8 de 38, e agora o 8 e honesto.
  O SEGUNDO ACHADO APARECEU NO REBASE, E ERA O MAIN QUEBRADO. O commit 4d24dbe gravou dados/pecas.json com DOIS documentos JSON completos, um atras do outro: 6.052 linhas, 316 KB, abrindo no editor e morrendo em json.load na linha 3.027. Os 35 links de afiliado daquele commit estavam INTEIROS no documento 1; o 2 era copia velha anexada. Consertado sem perder nada dos dois lados. E nasceu o portao que faltava: validar-banco.py passa a exigir que TODO dados/*.json parseie, antes de qualquer invariante — mesma familia do cabecalho YAML da secao 2 do contrato, e a frase de la serve inteira: arquivo que so o olho le e arquivo sem portao. Nenhuma das 12 reguas desta ilha chega a COMECAR sobre um arquivo que nao abre.
  A PAGINA DE DIVULGACAO DIZIA AO LEITOR QUE NADA RENDIA COMISSAO ENQUANTO 68 LINKS RENDIAM. A segunda conta vinha de com_link, que conta FICHA de produto, e a pagina a apresentava como 'quantos rendem comissao' — os dois foram o mesmo numero enquanto a unica alternativa a ficha era a busca crua. Com os links encurtados de hoje a frase ficou falsa, e falsa justamente na pagina cujo assunto e nao enganar o leitor sobre o que rende dinheiro. SUBDECLARAR RELACAO PAGA E TAO ERRADO QUANTO SUPERDECLARAR. A conta passou a ser a da ESCADA: 73 itens publicaveis, 68 rendem comissao, 5 nao. Isso fecha o item 1 da definicao de pronta.
  E A ESCADA COBROU QUATRO REGUAS DE UMA VEZ: teste-r1, teste-a1, teste-r2, teste-a2 e a secao 11 do conferir-no-ar.py exigiam rbm-comprar-cru > 0, ou seja, exigiam que a vitrine saisse pelo degrau 4 da 25.1. Quando os links encurtados chegaram, as paginas SUBIRAM para o degrau 3 e as cinco reguas reprovaram a melhora — duas delas NO AR. Quando quatro reguas erram igual no mesmo dia, o erro nao e de nenhuma delas: e de terem sido escritas quando so existia um degrau alcancavel, cada uma sem saber das outras. Todas passaram a medir 'o bloco de compra nunca fica vazio' e a IMPRIMIR o degrau ao lado.
  E UMA BATERIA ESTAVA INERTE POR MELHORA DO BANCO: mutacoes-par-sem-modelo media um defeito que so morde quando ha par com modelo null, e as 9 ligacoes deste bloco zeraram os nulls. Ela rodava, aplicava o defeito e nao pegava nada. Passou a PLANTAR o mundo antes de aplicar, e ganhou a linha do MUNDO SADIO, que tem de passar — 6 de 6.
  BANCADA, 0 falha: teste-r1 223, teste-r2 107, teste-casca 205, teste-a1 68, teste-a2 74, teste-arvore 219, teste-voz 155, teste-acentuacao 17, teste-purga-cache 21, teste-escada-compra 721, validar-banco aprovado, conferir-canal-na-resposta 74 afirmacoes, php -l limpo nos seis snippets. MUTACOES: 22 baterias, todas no resultado esperado, ZERO inertes.
  NO AR: Sync em dois disparos, /status na revisao do manifest, conferir-no-ar.py 229 afirmacoes e 0 falha, com as secoes 9, 10 e 11.
  O PROXIMO PASSO, MEDIDO E NAO LEMBRADO: o item 2 e o unico aberto da Fundacao e precisa de 8 para 15. Os tres caminhos, em ordem de retorno: (1) POSITIVO — marca brasileira que publica Pa E tem pagina de acessorios propria; a busca de hoje achou PRA100 (2.000 Pa), PRA600 e PRA90 fora do banco, e positivo-pra500 esta em 'so a R2' esperando UMA peca. E o unico alvo que mexe nos dois lados com canal brasileiro garantido. ATENCAO: as duas passadas de busca DIVERGIRAM sobre o Pa do PRA800 e do PRA2000 (2.300/2.800 contra 2.800/3.000), entao a coleta tem de resolver pela regra de divergencia antes de gravar. (2) WAP — medido NEGATIVO hoje para Pa de W100, W300 e WSMART: a marca publica autonomia, reservatorio e filtro, e nao pascal. Nao insista sem fonte nova. (3) Electrolux e Multi seguem sem Pa em canal nenhum, ja medido tres vezes. A rede: egresso direto fechado em www.wap.ind.br, mais.conteudo.wap.ind.br, loja.electrolux.com.br, manuals.plus, lamina.multilaser.com.br, www.multilaser.com.br e www.mi.com/br (000 nos sete, medido hoje); o canal de BUSCA alcanca todos. E a busca devolveu dois enderecos que o banco nao tinha: loja.wap.ind.br e o PDF do manual do W100 em mais.conteudo.wap.ind.br — o PDF segue bloqueado no WebFetch.
