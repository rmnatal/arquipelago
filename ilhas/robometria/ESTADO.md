...
bloco_atual: |
  O PISO DA 25.2 CHEGA A TELA, E O DESEMBARQUE DESTA ILHA PARAVA NO CACHE DO HOSPEDEIRO (casca 1.6.2, R1 1.8.0, R2 1.6.0, A1 e A2 1.3.0, esquema versao 7, manifest revisao 40). NENHUMA URL nova, NENHUMA URL mudou, NENHUMA peca ou modelo entrou ou saiu do banco.
