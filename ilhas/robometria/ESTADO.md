...
bloco_atual: |
  ...
  O QUE SAIU: os tres titulos e as tres metas da banda 4 a 10 passaram a citar numero derivado do banco, com a fonte. 'Existe filtro universal de robo aspirador? - 0 das 35 pecas', 'Quantos Pa o seu robo aspirador precisa - de 1.400 a 10.000 Pa', 'Quantos m2 um robo aspirador limpa por carga - 1 de 5 marcas'. NENHUM dos seis numeros e digitado: saem de casca-fatos.json, derivado do banco commitado por gerar-casca-fatos.py, que ganhou cinco medicoes novas com a regua de cada uma escrita nele.
  A REGRA QUE FOI INVERTIDA, E POR QUE ISSO NAO E AFROUXAR: a casca dizia desde 11/09 'nenhuma descricao carrega numero'. O que ela proibe e numero DIGITADO, e o motivo esta nela mesma — 'uma metade que nao fala com o banco'. Quem chega por casca-fatos.json fala com o banco por construcao, entao o motivo nao o alcanca. Molde com digito continua reprovando, e o portao ganhou a direcao que faltava: cabeca que declara numeros e NAO serve digito no ar tambem reprova.
  A MARCA CEDEU O LUGAR, NAO O NOME. O teto do <title> e 65 e ' - Robometria' come 13. O nome canonico continua um so nas cinco superficies; o que sai e o carimbo da marca, e so nestas tres paginas. A ilha tem 0 clique organico medido: ninguem a procura pelo nome.
  O NUMERO DO Pa QUASE SAIU ERRADO, E O QUASE E O ACHADO. A faixa e contada sobre os modelos RECOMENDAVEIS (publicavel COM canal brasileiro). Sobre publicaveis o teto seria 15.000 Pa, de um Xiaomi que a Xiaomi Brasil nao vende e que o portao da R2 nunca sugere — o titulo prometeria na SERP uma succao que a ferramenta se recusa a recomendar.
  UM PORTAO MORTO ACHADO DE QUEBRA: a proibicao de digito lia $c['titulo'], campo que SAIU do mapa das cabecas na casca 1.4.0. Essa metade media string vazia havia seis dias. E a bancada passou a medir a frase RESOLVIDA em vez do molde: 'de %1$s a %2$s Pa' tem 17 caracteres e o que o Google corta tem 20.
  ITEM 2 DA DEFINICAO DE PRONTA: BLOQUEADO POR REDE, MEDIDO HOJE. As cinco portas de fabricante que o PROMPT.md nomeia devolveram 403 do proxy de egresso na mesma passada (wap, electrolux, mi, positivo, multilaser) — policy denial, nao intermitencia. A API da Shopee, que esta nuvem alcanca, ja foi medida e nao traz pa_declarado nem canal_brasileiro. Destrava com uma linha de configuracao do Raphael (20.1/20.3), nao com bloco. A intersecao segue 8 de 38 e o placar deve dizer 'bloqueado por rede', nunca 'faltando'.
  BANCADA 0 falha: casca 251 (era 219), voz 164 (era 155), r1 227, r2 107, a1 74, a2 80, arvore 219, acentuacao 17, escada-compra 681, validar-banco aprovado. MUTACOES: promessa-do-titulo 6 de 6 com o mundo sadio passando e nenhuma inerte. NO AR: conferir-no-ar.py com a forma da promessa por pagina, 264 afirmacoes e 0 falha, na revisao 59.
