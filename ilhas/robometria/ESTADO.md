...
ultima_execucao: 2026-09-13T19:16Z
executando_desde: 2026-09-13T21:29Z
bloco_atual: "O PISO DA 25.2 NASCE NO ESQUEMA E NO BANCO, E OS 62 ITENS PUBLICAVEIS SAEM DE 'esperando link' PARA 'com palavra-chave escrita' (esquema de banco versao 5, manifest revisao 30, /status conferido as 19h35Z em UM disparo, com o ar reconferido DEPOIS dele — conferir-no-ar 149, conferir-kits-no-ar 163 e conferir-atribuicao-no-ar 19, 0 falha nas tres. NENHUMA URL nova, NENHUM snippet tocado, NENHUMA pagina servida mudou). Era o item (a) que a execucao das 17h22Z deixou nomeado como o maior buraco da ilha, e ele continuava intacto: url_busca nao existia em NENHUM arquivo do banco. MEDIDO ANTES DE CONSTRUIR, pela 20.2, as 19h16Z: robometria.com.br em 200 na home e no /status; shopee.com.br/search em 200 servindo casca de JavaScript com ZERO ocorrencia de 'shopee.com.br/'; affiliate.shopee.com.br/offer/custom_link em 200 servindo casca com ZERO ocorrencia de 'custom_link'; mercadolivre.com.br em 403. O encurtamento segue fora do alcance desta nuvem, e a Aquametria mediu o mesmo duas horas antes — AS DUAS ILHAS ESTAO NA MESMA POSICAO E VIRAM A CHAVE NO MESMO DIA. A CORRENTE TEM DOIS ELOS E ESTE BLOCO SEPARA OS DOIS: escolher a palavra-chave nao depende de sessao de ninguem, encurta-la depende. O que estava na fila esperando o Raphael nao era a escolha, era o encurtamento. Nasce ferramentas/gerar-busca-de-produto.py, que escreve url_busca_produto nos 62 publicaveis; NO DIA DA SESSAO SAO 62 COLAGENS E NENHUMA LINHA DE CODIGO MUDA. A FRASE DO PROPRIO ESQUEMA QUE CONTRADIZIA O CONTRATO FOI REESCRITA E NAO ACRESCENTADA: o campo afiliado dizia que 'quem gera o link e a Sentinela estrategica, no navegador do Raphael, com teto de calendario', e a 25.2 decide o contrario com a palavra do dono citada — 'deve ser 100% automatico sem eu tocar' e 'nada, nunca, fica na fila esperando o Raphael'. Duas frases em desacordo no mesmo arquivo nao sao historia, sao armadilha: a proxima execucao acredita na que ler primeiro. O ACHADO DO BLOCO E DA MARCA, E E DESTA ILHA E DE MAIS NENHUMA: nem o id nem o nome das marcas serviam para buscar. O id de duas das cinco e palavra comum do portugues (multi, positivo) e o nome de duas envenena consulta de marketplace — 'Multi (ex-Multilaser)' levaria PARENTESE para dentro da busca e 'Positivo Casa Inteligente' gasta tres tokens onde um basta. Nasce nome_de_busca em marcas.json, obrigatorio, para marca nova nao entrar muda. E A ARMADILHA DA 25.3 TEM AQUI UMA SEGUNDA FORMA, A DO CODIGO: S20 sozinho e um celular de outra marca, E10 e H40 sao codigo de qualquer coisa, W90 nao diz nada — por isso o termo de contexto entra nas DUAS entidades. A ASSIMETRIA ENTRE MODELO E PECA E DECISAO DECLARADA, COM A MEDICAO QUE FALTA NOMEADA: modelo leva o codigo (Electrolux ERB60 robo aspirador) porque o codigo do modelo E o nome comercial; peca NAO leva (WAP escova lateral robo aspirador) porque codigo de peca e SKU interno e o vendedor nao o digita no titulo, e chave com token que ninguem usa traz zero resultado — o beco sem saida que o piso existe para impedir. O que nao da para medir daqui esta ESCRITO em vez de escondido: a busca da Shopee serve casca de JavaScript, entao esta nuvem nao CONTA resultado nenhum, e entre falhar em 'resultado menos relevante' e falhar em 'beco sem saida' a secao 8 manda ficar com o modo de falhar conhecido. O estreitamento e melhoria e ja tem dono: a Open API da 25.6, cujo primeiro uso escrito no contrato e 'buscar produto por palavra-chave COM ESTOQUE'. O QUE ENTROU: esquema versao 5 com seis campos novos em afiliado (url_produto, motivo_sem_url_produto, degrau, url_busca, url_busca_produto, motivo_sem_url_busca), o bloco escada_de_compra com os quatro degraus da 25.1 nomeados, sete invariantes novas, nome_de_busca nas cinco marcas e 62 chaves escritas — 50 DISTINTAS, com 7 chaves cobrindo 19 itens, que e a largura MEDIDA da escolha de nao por o codigo da peca, publicada em vez de escondida. VERIFICACAO NA BANCADA, 0 falha: teste-escada-compra 487 afirmacoes (novo), com regua PROPRIA que nao importa o gerador nem o validador — duas metades que erram juntas ficam verdes, e foi assim que a atribuicao da funcao da R1 passou por todos os portoes ate hoje de manha. Dez ancoras escritas a mao, cada uma uma borda, e DUAS afirmacoes para a regua nao envelhecer calada: o conjunto de marcas e o de entidades que ela conhece tem de ser igual ao do banco e ao do esquema, entao marca nova REPROVA em vez de passar por cima. validar-banco APROVADO na versao 5; teste-r1 106, teste-r2 92, teste-a1 56, teste-a2 73, casca 200, voz 155, acentuacao 17, arvore 213; php -l limpo. MUTACOES: 143 em 13 baterias, 0 INERTES — as 126 antigas rodadas INTEIRAS porque este bloco reordenou o campo afiliado nos dois arquivos de banco. A bateria nova tem 17 e e mais dura que as irmas em duas coisas: cada mutacao declara QUAL portao tem de reprova-la e COM QUE PALAVRA (defeito pego pela regra vizinha prova que ALGUMA trava existe, nao que ESTA existe), e a maioria PRODUZ O MUNDO, porque a ilha tem 62 publicaveis e ZERO ficha de produto — as travas de degrau, de url_produto e de degrau-3-sem-piso nasceram hoje sobre um banco que nunca as exercita. As quatro ultimas criam o PRIMEIRO link de afiliado desta ilha dentro da copia e so depois quebram a regra nele; a ultima entrega esse mundo INTACTO e TEM de passar. UMA MUTACAO NASCEU INERTE E QUEM MOSTROU FOI A PROPRIA BATERIA: a que faz a marca voltar a ser buscada pelo nome de tela so editava o marcas.json, e o portao seguia verde, porque a chave ja gravada nao muda sozinha. O conserto rendeu DUAS mutacoes, e a segunda vale por si — com o marcas.json mudado e o banco NAO regerado, as duas copias do mesmo fato ficam em desacordo, e quem ve isso e o VALIDADOR, que le a marca do arquivo, nunca o portao, que tem o token escrito a mao. A DIVIDA DEIXOU DE SER PROSA E VIROU NUMERO CONTADO, recomputado do arquivo pelo validador: itens_com_ficha 0 de 62, itens_sem_piso 62 de 62, links_sem_degrau 0 de 0. Enquanto era prosa, o cabecalho dizia 'nenhum link de loja em nenhum cartao' e NAO DIZIA QUE 62 ESTAVAM SEM PISO, que e outra coisa e e a que a 25.2 chama de defeito. O QUE ESTE BLOCO NAO FEZ, COM NOME E MOTIVO: a escada NAO CHEGOU A TELA, e e escolha declarada, a mesma que a Aquametria fez as 17h20Z sobre a mesma clausula. Com url_busca vazia nos 62, o estado em que a busca vira botao NUNCA acontece e a linha discreta do outro estado nao tem para onde apontar: seria refatoracao em quatro superficies (R1, R2, A1, A2) provadamente DORMENTE, e meia refatoracao em quatro superficies que discordam em silencio e pior que nenhuma. O cartao continua dizendo 'Link de loja em breve', que e verdade hoje e deixa de ser no minuto em que houver sessao. BANCO SEM MUDANCA DE CONTEUDO TECNICO: 38 modelos (33 publicaveis), 32 pecas (29 publicaveis), 59 pares. Pauta da secao 17: pauta.md ainda nao existe — 0 escritos, 0 na fila, 0 recusados. ABERTO E NOMEADO: (a) OS 62 url_busca DEPENDEM DE UMA SESSAO — a palavra-chave esta escrita nos 62, falta o encurtamento, e no dia da sessao sao 62 colagens e nenhuma linha de codigo; (b) a escada nao esta na tela, com os dois motivos acima; (c) o reenvio do sitemap no Search Console, metade humana do despacho de 10/09, segue travando a leva de malha 5b; (d) 13 arquivos seguem fora do manifest (contados nesta execucao; o cabecalho anterior dizia 23 e o numero nao batia mais) e o atualizar-manifest.py avisa e SEGUE — os TRES portoes novos deste bloco ENTRARAM, entao a divida nao cresceu com ele; (e) a ilha NAO TEM PAGINA DE PRIVACIDADE, com GA4 no ar. PROXIMO, com ordem e motivo: (1) o RECIPIENTE DE PO do W300 e do WSMART, a coleta mais barata que existe hoje — a pagina ja esta localizada e reservatorio e o unico tipo do vocabulario com ZERO peca, entao a primeira devolve o tipo ao seletor da R1 de graca; (2) W90 Perola, W96, W3000, W4000, W2000 e WConnect, localizados e nao gravados por falta de duas passadas limpas proprias; (3) o S10 e o Mop 2 seguem sendo os dois Xiaomi vazios; (4) a escada na TELA, no minuto em que houver url_busca para ela servir, em bloco inteiro nas quatro superficies de uma vez."
