...
bloco_atual: |
  ...
  A ESCOLHA DA ILHA: primeira tentada, sem corrida. Os cinco ESTADO.md com executando_desde null, que pela 1.1 ja significa que nao ha bloco da Fundacao vivo. Pela 18.1 duas ilhas tinham despacho ABERTO do Raphael, os dois de 14/09 e escritos no mesmo commit; empate de data, entao valeu a rotacao da secao 1 e a robometria tinha a ultima_execucao mais antiga (13h54Z contra 14h34Z). Rede pela 20.2 antes de trabalhar: home 200 e /status na revisao 36, igual a do manifest.
  A FRASE PROIBIDA SAIU DE CINCO LUGARES. 'Link de loja em breve' vivia na casca, na R1, na R2, no A1, no A2 e numa secao inteira da /divulgacao-de-afiliados/ que existia para explica-la ao leitor. A intencao original era boa e esta registrada — reservar o lugar era melhor do que esconder o bloco, porque esconder devolvia a procedencia o papel de unica porta clicavel. So que RESERVAR O LUGAR COM UMA PROMESSA E OUTRA FORMA DE BECO SEM SAIDA: em 65 de 65 itens publicaveis, quem decidia comprar nao tinha para onde ir. O que faltava nunca foi decisao, era o ELO — a palavra-chave esta no banco desde 13/09 e o que depende da sessao do painel da Shopee e so o ENCURTAMENTO (25.6).
  A BUSCA CRUA SAI SEM rel=sponsored, e e decisao registrada: sponsored e a declaracao de relacao PAGA, e ninguem paga por aquele clique. A pagina de divulgacao passou a dizer ao leitor qual link rende comissao e qual nao rende, e o 'Estado de hoje' ganhou DUAS contas, porque sao duas coisas que eram o mesmo numero so enquanto nenhum item tinha saida nenhuma.
  O DEGRAU ERA UMA DECISAO TOMADA E NAO GRAVADA: 65 publicaveis com piso escrito e degrau null, e null quer dizer 'ninguem decidiu'. A REGUA DO VALIDADOR ESTAVA INVERTIDA e foi reescrita — ela dizia 'degrau sem ficha nao parou em lugar nenhum', o que contradiz a propria 25.1, cujo degrau 4 E a busca e por definicao nao tem ficha. A contagem itens_sem_piso morreu: contava quem nao tinha o link ENCURTADO e chamava isso de 'sem piso', e virou itens_sem_saida_de_compra (0, o defeito da 19.1) e itens_com_piso_nao_rastreavel (65, divida de comissao).
  ITEM 2 DA SENTINELA, E A DIFERENCA NAO ERA A QUE ELA SUPOS: nao sao os kits abrindo uma linha por peca. Contado, a tabela tem 73 LINHAS (modelo, tipo, peca), responde 63 CELULAS (modelo, tipo), mostra 56 PARES, e o banco declara 63 PARES — os DOIS 63 sao grandezas diferentes que hoje dao o mesmo numero por acidente. Igualar os numeros, que era o conserto tentador, teria colado duas contas que nao sao a mesma. A secao 19 do teste-r1.php exige que a pagina chame cada uma pelo seu nome ENQUANTO forem iguais, porque e enquanto sao iguais que ninguem percebe que foram confundidas.
  ITEM 3 DA SENTINELA, DOIS DEFEITOS VIRANDO QUATRO: divergencia era decidida comparando NUMEROS e nunca quem os publicava; a oracao quebrada vinha de um molde de um tamanho so; nasceu um QUARTO molde (dois numeros, um publicador), porque tirar liso|nao do molde da divergencia o jogaria no da 'UNICA recomendacao', onde ha duas; e a CONTRACAO, que a ronda nao viu — carpete|nao servia 'e a de a Canaltech', com a regra de contracao tendo nascido nesta ilha na manha do mesmo dia. A linha de procedencia passou a ter uma entrada por DOCUMENTO e nao por limiar.
  ITEM 1 DA SENTINELA: A CAUSA E MAIS ESTREITA E O QUE ESTAVA POR BAIXO E MAIOR. Nao e 'sem gzip' — e SEM CABECALHO Accept-Encoding NENHUM (gzip, identity e br trazem a pagina de hoje; nenhum cabecalho traz a de 11/09). E o desembarque desta ilha PARAVA NO CACHE DO HOSPEDEIRO: assinatura 'Generated by Endurance Page Cache' no HTML, e ele purga quando um POST e salvo no wp-admin enquanto o Sync grava OPTIONS e atualiza SNIPPETS. MEDIDO: a revisao 37 aplicou, o /status respondeu 37, as nove URLs deram 200 — e o endereco canonico continuou servindo a copia das 14h40, sem UM botao de compra. E A SECAO 4 DO CONTRATO UMA CAMADA ABAIXO.
  E NENHUMA REGUA VIA: o conferir-no-ar.py APROVOU a revisao 37 com 167 afirmacoes e zero falha sobre uma pagina velha, porque nenhuma delas encostava no que o bloco tinha mudado. Nasceram a secao 10 (o canonico contra o mesmo endereco com quebra de cache) e a secao 11 (o piso no HTML servido, e a AUSENCIA da frase proibida). As duas reprovaram na hora, nomeando 3 contra 15.
  VERIFICACAO, 0 falha na bancada: teste-r1 216, teste-r2 107, teste-casca 205, teste-a1 68, teste-a2 74, teste-arvore 219, teste-voz 155, teste-acentuacao 17, teste-escada-compra 706, validar-banco aprovado, php -l limpo. MUTACOES: escada 24 de 24, divergencia-r2 5 de 5 (bateria NOVA), procedencia 17 de 17, a2-procedencia 15 de 15. DUAS MUTACOES VIRARAM INERTES e a bateria as acusou — as que editavam a saida degradada pela frase antiga deixaram de achar o alvo, editaram NADA e ficaram verdes.
  NUMEROS DO PISO: 65 publicaveis, 65 com piso, 65 com degrau 4, 0 SEM SAIDA DE COMPRA, 65 com saida que nao rastreia, 0 com ficha, 0 intestaveis.
  O BLOCO ESTA NO AR, E O MEIO DO CAMINHO EU LI ERRADO. As acoes do EPC foram ao ar na revisao 39 e o esvaziamento da pasta do cache na 40; medindo logo depois, o canonico continuava velho e eu RETIREI a purga por arquivo na 41. A MEDICAO QUE ME CONVENCEU DISSO ESTAVA ERRADA: eu comparava cabecalhos de um curl -I (HEAD) com o corpo de um GET feito segundos depois — duas requisicoes, dois estados do cache —, e o 'no-store sem last-modified' que parecia provar que a camada estava a frente do Apache era o retrato de um arquivo sendo apagado naquele instante. Medidos JUNTOS (curl -D - -o), HEAD e GET concordam. FICA A REGRA DE METODO: cabecalho e corpo da mesma URL se medem na MESMA requisicao, senao a comparacao descreve dois instantes e conclui sobre um.
  E O RELOGIO DESFAZ A OUTRA METADE: a entrada presa era de 14h40:01 com max-age de 7200 s, entao so venceria as 16h40, e foi RECRIADA as 16h05:59 durante o Sync da revisao 41, com a purga por arquivo sendo o codigo que rodava. Nao e prova de causa, e a unica causa identificada com o vencimento por tempo descartado. A purga foi RESTAURADA na revisao 42 (casca 1.6.4), com a atribuicao dita como inferencia e com o teste que a decide escrito no proprio codigo.
  ESTADO REAL, medido as 16h07Z no endereco CANONICO: quatro saidas de compra pela busca, ZERO ocorrencias da frase proibida, '73 linhas' na tabela, a /divulgacao-de-afiliados/ limpa, e a frase da R2 nomeando duas fontes distintas. conferir-no-ar.py: 220 afirmacoes, 0 falha, incluindo as secoes 9, 10 e 11 que nasceram hoje. O BLOCO ESTA ENTREGUE.
  O QUE SOBRA E NAO BLOQUEIA: entre o Sync e a purga, o /status afirma que esta tudo aplicado enquanto o leitor pode estar na pagina de antes — hoje isso custou quatro revisoes de diagnostico. O despacho para o Raphael foi REBAIXADO de ALTA para NORMAL e pede, como oportunidade, uma purga por API do painel. A PRIMEIRA COISA DE TODA EXECUCAO DESTA ILHA passa a ser rodar conferir-no-ar.py e olhar as secoes 9, 10 e 11.
