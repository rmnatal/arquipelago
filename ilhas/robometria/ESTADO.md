...
ultima_execucao: 2026-09-18T16:38Z
executando_desde: 2026-09-18T19:18Z
bloco_atual: |
  ITENS 2 E 3 DO DESPACHO DA SENTINELA DE 18/09 FECHADOS E CONFERIDOS NO AR; 1 E 4 REESCRITOS PELA 18.3. Casca 1.11.0, R1 1.11.0, R2 1.9.0, manifest revisao 67, /status em 67. ZERO URL nova, ZERO URL mudada de endereco. Correcao nao consome a vez de um bloco de construcao (18.2) — e continua nao havendo bloco de construcao elegivel nesta ilha ate o Raphael decidir sobre a foto de fabricante.
  A ESCOLHA DA ILHA: PELO FOCO DA 1.2, SEM CORRIDA. foco.md nomeia robometria desde 16/09. executando_desde estava null, que pela 1.1 ja significa que nenhum bloco da Fundacao esta vivo; o ultimo commit da pasta era de 14h52Z e e commit de RONDA, que pela 1.1 nao reserva nada. Reserva aceita de primeira as 16h16Z. Zero branch claude divergente e zero PR aberto. Rede pela 20.2 antes de trabalhar: home 200 em TRES passadas e /status na revisao 66, igual a do manifest.
  ITEM 2 — O PISO DOS 95 VOLTOU A RENDER COMISSAO. 22 publicaveis (15 pecas, 7 modelos) saiam pela URL crua de busca, sem sponsored e sem sub-id: clique que funciona e nao paga nada. Os 22 ganharam url_busca encurtada pela Open API, 73 reaproveitados sem gastar chamada, e itens_com_piso_nao_rastreavel voltou a 0 nos dois cabecalhos. casca-fatos passou a dizer rendem_comissao 95.
  E A TRAVA, QUE ERA A OUTRA METADE DO PRONTO QUANDO: a regra de piso cobrava url_busca OU motivo escrito — e quem escreve o motivo e o GERADOR, sozinho, entao a segunda condicao aprovava sempre. Foi por essa porta que a conta foi de 0 (16/09) para 22 (18/09) com todos os portoes verdes: ninguem quebrou nada, a ilha cresceu mais rapido que os proprios acabamentos. A 25.2-b nomeia o que faltava — AUSENTE E DIFERENTE DE TENTADO-E-FALHOU — e a prova da tentativa ja existia em dados/palavras-chave-medidas.json. O validador passou a ler esse arquivo, em vez de ganhar campo novo que o gerador tambem preencheria sozinho.
  AS DUAS DIRECOES SAO MEDIDAS: m23 tira o registro da medicao e o validador reprova; m24 deixa o registro na medicao SEM link curto e o validador tem de PASSAR. Trava que reprovasse o m24 empurraria a ilha a esconder peca que nao da comissao — o oposto do que a 25.2-b decidiu.
  ITEM 3 — A PAGINA NEGAVA O BOTAO QUE ELA MESMA SERVIA. A R1 imprimia "Nenhuma destas 2 pecas tem link de loja ainda" com dois botoes de afiliado vivos logo abaixo; a R2 dizia "6 destes modelos ainda nao tem link de loja" e servia NOVE botoes. Em 66 dos 95 publicaveis a frase era falsa. A causa nao era o texto: as duas contavam afiliado.url (a FICHA) enquanto o botao vinha da escada da 25.2, cujo piso e a BUSCA — duas metades contando a mesma coisa sem nunca se falarem, a familia do painel da foto da 25.7. Nasceu robometria_casca_degrau_da_porta(), uma funcao so, e as frases perguntam a ela.
  A FRASE FALSA DEU LUGAR A UMA VERDADEIRA, NAO AO SILENCIO: as telas dizem agora quantos itens abrem a BUSCA da loja em vez da ficha. E informacao de compra e e o contrario de uma promessa, que e o que a secao 7 proibe.
  E A BANCADA COBRAVA A FRASE FALSA — o pior pedaco do achado. A afirmacao "a pagina publica quantas pecas estao esperando link de loja" EXIGIA o numero errado na tela: regua que cobra o sintoma sustenta o defeito, e esta ficou dois dias sustentando este. A nova le o HTML servido e reprova a combinacao que o despacho nomeou, com a direcao contraria junto para nao virar verde barato.
  ITENS 1 E 4 FICAM, E O MOTIVO E DE REGUA E NAO DE FOLEGO. Os dois foram medidos na busca do SITE, no navegador. Da nuvem, api/v4/search/search_items devolve HTTP 403 com error 90309999 — remedido hoje as 16h20Z, e e o que a 25.4 ja mandava nao redescobrir. E a metade medida hoje e pior que "nao deu": com a regua que a nuvem TEM, as 25 chaves Roborock e Xiaomi trazem a marca no topo e a chave do item 1 devolve RESULTADO, nao zero. A escada desta ilha nao enxerga nenhum dos dois defeitos. Passa-los por ela devolveria verde sobre defeito vivo, que pela 18.4 e pior que deixa-los abertos.
  A LICAO DE METODO: as duas reguas discordam NO SENTIDO QUE ENGANA — a que a maquina alcanca e a otimista, porque mede o catalogo que paga comissao e nao o que o leitor ve. A advertencia estava escrita em nota_de_universo desde 16/09; hoje foi a primeira vez que custou um defeito real no ar.
  BANCADA, 0 falha: casca 251, r1 229, a1 74, r2 107, a2 80, acentuacao 17, arvore 219, voz 164, purga-cache 21, escada-compra 879, validar-banco APROVADO, e as 27 baterias de mutacao com saida 0. A escada-compra caiu de 916 para 879 e a queda esta CONTABILIZADA: 15 pecas deixaram de precisar da afirmacao de chave estreitada por passarem a ser medidas, e 22 itens deixaram de precisar do motivo escrito por terem link. Nenhuma regra foi desligada — a conta foi refeita registro a registro contra o main anterior.
  A CREDENCIAL DA SHOPEE NAO TOCOU O DISCO: lida do documento privado do Drive pelo conector (25.6) e passada so como variavel de ambiente do processo. git grep pelo AppID e pela chave na arvore inteira antes do push: 0 arquivo.
