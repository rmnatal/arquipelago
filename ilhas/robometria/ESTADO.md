...
ultima_execucao: 2026-09-12T23:18Z
executando_desde: 2026-09-13T11:34Z
bloco_atual: "O KIT DO ERB80 E O PANO DE MICROFIBRA ENTRAM NO BANCO, E UM PRONOME SEM ANTECEDENTE SAI DO AR (bloco 3c, R1 1.3.0, manifest revisao 24, /status conferido as 23h30Z em UM disparo; nenhuma URL nova). REDE reconferida como a 20.2 manda, duas passadas: a ilha em 200 nas duas, loja e content.electrolux, mi.com.br e wap.ind.br em 000 por POLITICA de egresso (o proxy nomeia connect_rejected) — nao e intermitencia de tunel. O canal de BUSCA alcanca os mesmos fabricantes, e foi por ele que os dois registros subiram. O KIT DO ERB80 ENTROU ACIMA DO NIVEL DO ERB44, E A PREVISAO DO PROMPT.md ESTAVA ERRADA — o que vale mais que o registro. O texto anterior dizia que ele entraria no nivel do ERB44 porque as leituras de entao devolveram so o trio generico. A pagina do kit no dominio do FABRICANTE descreve os tres itens UM A UM e nomeia a escova pelo TIPO ("escovas laterais, direita e esquerda"). A CONFERENCIA QUE SUSTENTA ISSO CUSTOU UMA LEITURA A MAIS e vale como regua: bloco por item em pagina de catalogo pode ser MOLDE do gerador de paginas, e molde nao declara nada sobre o produto — quem separa as duas coisas e ler a pagina IRMA com a MESMA pergunta. A do ERB44, mesmo dominio e mesmo formato, traz so a copia generica. Logo o bloco por item existe na pagina do ERB80 porque a Electrolux o escreveu la, e de quebra isso CONFIRMA que o tipo:null da escova do ERB44 foi acerto e nao preguica. QUANTIDADE FICOU NULL NOS TRES, de proposito: "direita e esquerda" esta em frase de BENEFICIO, nao em lista de conteudo de embalagem, e ler dali um 2 e transformar prosa de venda em quantidade declarada. A busca ofereceu "1 filtro, 1 pano e 2 escovas" dizendo TEXTUALMENTE que era baseada em kits similares de outros modelos, e foi RECUSADA. O PANO DE MICROFIBRA ERB60/61/62/80 ENTROU JUNTO e nao estava previsto em lugar nenhum: apareceu na mesma varredura, e a licao de fila e que varredura feita para UM alvo devolve vizinhos — este era mais barato que o alvo. Primeira peca avulsa desta ilha a servir o ERB80, cobre quatro modelos. O DEFEITO QUE OS DOIS REGISTROS DESENTERRARAM, E ELE JA ESTAVA NO AR EM TRES PAGINAS: a frase do kit-com-avulso era "Ele tambem vem dentro do kit ...". O pronome so apontava para alguma coisa por SORTE DE ORDEM — as frases saem na ordem do banco, e no unico caso que existia (o filtro do ERB60/61/62) a peca avulsa vinha antes do kit. Com o pano dando ao MOP um avulso, a frase do kit saiu na posicao do KIT: depois da escova lateral e ANTES de o mop ser nomeado. OITO PORTOES VERDES, porque todos mediam a frase sozinha e sozinha ela estava certa — FRASE E A UNIDADE ERRADA quando a correcao depende da frase vizinha. A saida NAO foi reordenar a lista, que devolveria o verde e deixaria a dependencia de pe: a frase passa a NOMEAR O TIPO nas duas implementacoes e fica autossuficiente (5.2 e 8 do contrato). TRAVA: secao 14 do teste-r1.php, regua escrita a mao no proprio teste, medindo so a PRIMEIRA ORACAO das frases das DUAS implementacoes, e contando as frases do tipo kit-com-avulso para nao dar verde sem medir. mutacoes-frase-nomeia-o-tipo.py, 4 de 4 reprovadas, e a terceira PRODUZ O MUNDO: quebra os dois lados juntos, a comparacao PHP x referencia continua VERDE e so a trava nova pega. A metade NO AR entrou no conferir-kits-no-ar.py, que foi de 9 para 14 estados. E UMA MUTACAO MORREU CALADA POR CULPA DESTA ENTREGA: duas do mutacoes-arvore.py tinham o numero DIGITADO nos dois lados ("pares_declarados": 32 -> 33); o banco cresceu, o alvo sumiu e elas deixaram de editar nada. Agora leem o valor de hoje e somam 1. A cicatriz do "numero de tela nasce contado" VALE PARA A BANCADA tambem. VERIFICACAO, 0 falha: bancada 901 afirmacoes em 8 portoes (teste-r1 de 93 para 96); php -l limpo; validar-banco aprovado com os mesmos 2 avisos de variante, e foi ELE que pegou sozinho as duas contagens digitadas do cabecalho de pecas.json. Mutacoes: 101 em 8 baterias, todas reprovadas. NO AR as 23h30Z em UM disparo: /status na revisao 24 igual a do manifest, 10 aplicados; conferir-no-ar.py 149 afirmacoes e conferir-kits-no-ar.py 71 (era 41), zero falha nos dois. BANCO: 20 pecas (18 publicaveis), 38 pares declarados, 46 esperando link de afiliado (eram 44). A R1 segue em 16 dos 28 modelos — o ERB80 ja respondia escova principal —, mas as celulas vazias caem de 123 para 120. Pauta da secao 17: pauta.md ainda nao existe — 0 escritos, 0 na fila, 0 recusados. PROXIMO: (1) pecas da XIAOMI e da WAP com codigo, e TESTE O CANAL DE BUSCA nesses dominios antes de declarar bloqueio — o egresso direto esta fechado por politica, mas a busca nunca foi testada la, e foi essa confusao que deixou os kits tres dias parados; (2) CATEGORIA DESCOBERTA e nao coleta pendente, o Kit 3 Sacos Descartaveis do ERB80: saco descartavel e consumivel de base autolimpante e o ERB80 tem base, mas tipo_de_peca nao tem esse tipo no esquema, e acrescentar tipo mexe no seletor da R1, na cobertura e nos portoes — decida SE o tipo nasce, pela regua da 14.3, antes de gravar registro; (3) o ERB40 tem Kit Performance proprio e o modelo nao esta em modelos-robo.json — modelo antes de peca; (4) a leva de malha (5b) segue travada pela metade humana do despacho de 10/09, o reenvio do sitemap."
