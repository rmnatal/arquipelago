...
ultima_execucao: 2026-09-12T19:18Z
executando_desde: 2026-09-12T21:16Z
bloco_atual: "A PROCEDENCIA CHEGA AO ULTIMO LUGAR QUE NAO A TINHA — a secao 'Exatamente no limiar' da R2 (snippet 1.3.0, manifest revisao 22, /status conferido as 19h30Z em UM disparo). A frase comecava por 'Xiaomi E10 declara exatamente 4.000 Pa': o modelo como sujeito do verbo declarar, que e o fabricante dito sem nome e sem degrau da escada de fontes. O cartao da vitrine fechou isso em 11/09 e esta secao ficou para tras JUSTAMENTE PORQUE NINGUEM A LE COMO RECOMENDACAO — e a pagina nomeia modelo e Pa aqui com a mesma autoridade que la. Agora a atribuicao vem de procedencia_do_pa() na implementacao de referencia, e cada item traz a ressalva do degrau e a linha 'Como sabemos — pagina do fabricante, verificado em 09/09/2026 · fonte'. SAO DOIS NUMEROS E DUAS PROCEDENCIAS (sexta decisao do PROMPT.md): o Pa e do modelo e o limiar e da fonte editorial, e a frase nomeia os dois separadamente, porque frase que publica dois numeros de origens diferentes nao pode atribuir os dois de uma vez. A DECISAO DE DESENHO DO BLOCO FOI A AUSENCIA DA PORTA DE COMPRA DITA EM VEZ DE CALADA: a regra da secao 7 (porta de compra antes da procedencia) existe para o link de fonte nunca ser a unica coisa clicavel de um bloco, e aqui a porta nao pode existir — a pagina acabou de dizer que estes modelos nao estao acima do limiar, e botao embaixo de uma recusa e recomendar assim mesmo. O que a regra proibe e o silencio sobre a ausencia, nao a ausencia; entao a pagina declara a ausencia e diz por que, e a mutacao que apaga essa frase reprova. TROCAR UM SILENCIO POR OUTRO NAO E CONSERTO. A CORRECAO QUE NAO APARECE NA TELA, E QUE SO VIRARIA NUMERO NO DIA DO PRIMEIRO LINK: afiliado.sub_id_2 SAIU DO BANCO. Ele nomeia a PAGINA que levou o clique, e o banco so sabe dizer um valor por registro — os 33 modelos traziam 'R2' e as 18 pecas 'R1'. Mas o mesmo modelo aparece na R2 E no artigo A2, e a mesma peca na R1 E no A1: os dois artigos publicavam a vitrine deles carimbada com o codigo da ferramenta irma. Hoje isso nao quebra nada; no dia do primeiro link de afiliado a medicao diria que os dois artigos nao vendem nada, COM CARA DE NUMERO CONFERIDO, e a decisao seguinte seria despublicar o que estava vendendo. O A1 TINHA O MESMO DEFEITO E NINGUEM TINHA VISTO — o despacho anterior nomeou so os cinco itens do A2, e o gerar-a1.py repassava o afiliado INTEIRO do registro da peca. Conserto: cada gerador carimba o proprio codigo (R1, R2, A1, A2), o campo saiu de modelos-robo.json e de pecas.json, saiu da forma do esquema-banco.json com o motivo escrito, e validar-banco.py REPROVA o campo de volta no banco. Nao se conserta trocando o valor no banco, porque nenhum valor unico e certo la; e campo que parece a regra e nao e, num arquivo publicado, e a mesma familia da funcao morta no snippet: um dia alguem o usa. VERIFICACAO: teste-r2 de 90 para 92, com a secao 17 nova varrendo a ENTRADA INTEIRA (9 situacoes, 16 itens em 8 delas) e com a regua lida do esquema e do banco, nunca do r2-respostas.json que o mesmo gerador escreve; teste-casca de 191 para 200, com o portao do carimbo morando NA CASCA e nao dentro de cada pagina, pelo mesmo motivo que a porta de compra mora la — pagina nova que copiar um gerador antigo reprova antes de existir URL. MUTACOES: mutacoes-procedencia de 11 para 17 de 17, e mutacoes-carimbo-de-origem novo, 5 de 5. Duas licoes: (a) a mutacao central do carimbo precisa das DUAS metades (gerador lendo o banco E campo de volta no banco), porque cada uma sozinha e inerte; (b) o alvo de uma mutacao antiga deixou de ser unico quando a frase nova passou a usar a mesma expressao — quatro tabs sao um pedaco de cinco tabs, e so a quebra de linha desempatou; a guarda de unicidade do proprio arquivo pegou, e sem ela a mutacao teria editado nada e passado verde. NO AR as 19h30Z: conferir-no-ar.py de 82 para 149 afirmacoes, 0 falha, com a secao nova medida no HTML SERVIDO e os dois modelos escritos literalmente no medidor. Regressao sem uma falha: teste-r1 (90), teste-a1 (55), teste-a2 (73), teste-acentuacao (17), teste-arvore (213), teste-voz (155), validar-banco, php -l em tudo, e as quatro baterias antigas de mutacao (15, 18, 29, 9) — nenhuma virou inerte. A pagina editada medida a parte em Chromium a 360/390/781/782/1200 px (0 px de rolagem nas cinco, os tres blocos de cada item empilhados) e teste-navegador-arvore nas 9 paginas x 6 larguras (258 medicoes, 0 falha). REDE reconferida (secao 20.2): dominio da ilha em 200; mais.conteudo.wap.ind.br, wap.ind.br e mi.com.br em 000 por POLITICA de egresso (connect_rejected), repetido em duas passadas com a ilha em 200 na mesma — e politica, nao a intermitencia de tunel. 44 itens esperando link de afiliado (nao mudou; este bloco nao tocou catalogo). NENHUMA URL NOVA e nenhum numero novo. Pauta da secao 17: pauta.md ainda nao existe — 0 escritos, 0 na fila, 0 recusados. PROXIMO: a transcricao da composicao dos kits, que destrava a porta de compra do Kit Performance na consulta ERB30 + filtro, e junto dela o item (e) da fila do 3c — a recarga dos cinco Electrolux que ja declaram cobertura e autonomia, o campo de menor custo e maior retorno do banco, porque e ele que completa a frase que e a razao de a R2 existir. AS DUAS DEPENDEM DA REDE QUE ESTA FECHADA acima; teste com curl antes de escolher o alvo, e se continuar fechada a fila cai para trabalho de repositorio. A leva de malha (5b) segue travada pela metade humana do despacho de 10/09 — o reenvio do sitemap no Search Console, que e do Raphael."
