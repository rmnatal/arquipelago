...
bloco_atual: |
  ...
  PARTE 1 — COBERTURA DE FOTO DE 27 PARA 29, E O ALVO REAL ERA 68 E NAO 76. Os outros 8 sem foto tem status excluido_do_banco (7) ou nao_publicavel (1) e nenhuma tela os renderiza. Casaram 2, os dois no degrau 4: multi-pr10205 e wap-escova-central-wsmart, as duas fotos abertas com os olhos antes de gravar e lidas depois no HTML servido. Residuo 66, com nome, numero e causa em dados/residuo-de-fotos-2026-09-18.md: 63 "a Shopee anuncia e nenhum titulo nomeia este registro", 2 casamento ambiguo, 1 sem anuncio na Shopee.
  O ACHADO: UM CASAMENTO ERRADO PASSOU PELA REGUA E FOI PEGO PELO OLHO (25.3). positivo-11206519 e a escova PRINCIPAL (o rolo) e casou com "Escova E Filtro Hepa Para Robo Aspirador Positivo Pra800"; a foto do anuncio traz um filtro e uma escova LATERAL de tres bracos. A causa: quando quem amarra o anuncio e o codigo do MODELO, o anuncio esta preso ao APARELHO, e o aparelho tem as DUAS escovas — o substantivo pelado nao escolhe entre elas. palavras_estritas_do_tipo desceu para coletar-shopee.py e passou a valer nesse caminho; mutacoes-qual-escova.py nasceu com 7 de 7 e cai para 4 de 7 com a trava desligada. Os 27 registros com foto anteriores foram reconferidos contra a regua nova: 0 reprovado.
  A COLETA PASSOU A RECONTAR AS QUATRO CHAVES DO CABECALHO QUE ELA MOVE, com as definicoes do proprio validar-banco.py, que continua conferindo.
