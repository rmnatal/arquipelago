...
ultima_execucao: 2026-09-13T15:32Z
executando_desde: 2026-09-13T17:35Z
bloco_atual: "AS PRIMEIRAS PECAS DA WAP ENTRAM, E A FUNCAO DA ESCOVA VIRA CAMPO PORQUE O TITULO DO FABRICANTE NAO A DECLARA (bloco 3c leva 6, esquema do banco versao 4, manifest revisao 28, /status conferido em DOIS disparos — 27 as 15h29Z com o banco, 28 as 15h35Z com a lista de compras e a marca; nenhuma URL nova, nenhum snippet reescrito). A R1 SAI DE 20 PARA 22 MODELOS QUE RESPONDEM e o vazio cai de 13 para 11 — W300 e WSMART saem da lacuna que a varredura de 10/09 apontou como urgencia numero 1. O banco vai a 32 pecas, 29 publicaveis, 59 pares. QUATRO PECAS ENTRAM, UMA E RECUSADA, E A RECUSA E O ACHADO DO BLOCO. O vocabulario desta ilha separa 'escova lateral' de 'escova principal' — sao FUNCOES, e e a funcao que decide se a peca encaixa. O fabricante batiza pela POSICAO: Direita, Esquerda, Central, Frontal, Rotativa, e nenhuma das cinco esta no vocabulario. A PROVA DE QUE LER A FUNCAO DO NOME E CHUTE VEM DA PROPRIA FONTE: o conteudo declarado do W300 chama de 'escovas GIRATORIAS direita e esquerda' o par LATERAL, e o artigo de limpeza do W90, no blog da MESMA marca, chama de 'Escova Principal (Escova GIRATORIA)' a PRINCIPAL. Mesma palavra, mesmo fabricante, funcoes opostas. POR ISSO A ESCOVA DO W90 NAO ENTROU: o catalogo daquele modelo publica UMA escova, sem vizinha para contrastar, enquanto o canal de manutencao da propria WAP declara que o W90 tem DUAS. Nao ha de onde ler a funcao, e ler do nome seria a heuristica por vizinhanca que a secao 8 proibe. O QUE DESTRAVA O W90 E O MANUAL FW010263 REV00JAN24, nomeado na busca e atras do egresso fechado — nao e falta de procura. A SEGUNDA RECUSA E O CODIGO, EM TODAS AS QUATRO: FW006267, FW008028 e FW009132 voltaram em UMA passada e SEMPRE em titulo de marketplace ou de varejista (niveis 5 e 6), NUNCA num canal da WAP; a segunda passada restrita a loja oficial devolve a pagina e o titulo e nao o campo da ficha. Os quatro registros usam codigo_fabricante null com motivo, pela mesma regra que ja vale para a Electrolux, e o par com o modelo e declarado pelo TITULO PUBLICADO — a regra escrita na leva Xiaomi de hoje mais cedo. Isto corrige pela metade a frase que estava em marcas.json: a ficha TEM codigo, e a busca e que nao o alcanca. O CAMPO NOVO: funcao{declarada_por, fonte, declarado_como}, obrigatorio nos tipos que o titulo do fabricante nao separa, com tres origens legitimas e so tres — o TITULO, o CONTRASTE do catalogo do fabricante para AQUELE modelo, e o CANAL DE MANUTENCAO. As 8 escovas que ja estavam no banco foram preenchidas: 5 pelo titulo, 3 pelo contraste (as duas Xiaomi 'Brush', que so significam principal porque a vizinha se chama 'Side Brush', e a Escova Frontal do WSMART). A LISTA DE TIPOS MORA NO ESQUEMA e nao dentro da regua (tipos_que_exigem_funcao_declarada), pelo mesmo motivo que matou o piso digitado do teste-acentuacao ontem: lista dentro da regua envelhece calada. A MUTACAO QUE IMPORTA E A (6) e ela nao estraga registro nenhum — tira do ESQUEMA a lista de tipos, e sem a trava que exige a chave o validador passaria a aprovar TUDO em silencio, com o banco de hoje verde e a peca seguinte entrando sem o campo. A REGRA SUBIU PARA O CONTRATO como secao 26 do ARQUIPELAGO.md, porque nao e da Robometria: toda ilha com vocabulario controlado classifica pela funcao e le titulo escrito pelo marketing de outra pessoa. VERIFICACAO NA BANCADA, 0 falha: validar-banco APROVADO; 902 afirmacoes em 8 portoes (casca 200, r1 96, a1 56, r2 92, a2 73, acentuacao 17, arvore 213, voz 155); php -l limpo. MUTACOES: 116 em 11 baterias, 116 reprovadas, 0 passaram, 0 inertes — as 109 antigas rodadas inteiras para provar que nenhuma morreu com o banco maior. NO AR: /status na revisao 28 igual a do manifest, 10 aplicados nos dois disparos; conferir-no-ar 149 e conferir-kits-no-ar 163 rodados DEPOIS de cada um dos dois, 0 falha nas quatro passadas; e a medicao que so este bloco tinha para fazer, no HTML SERVIDO e com parametro anti-cache (a armadilha que o bloco das 13h32Z nomeou): ?modelo=wap-w300 serve 'declara a escova lateral "Escova Direita..."' e 'a escova lateral "Escova Esquerda..."' e NAO serve Central nem Frontal; ?modelo=wap-wsmart serve 'a escova principal "Escova Central..."' e 'a escova lateral "Escova Frontal..."' e NAO serve Direita nem Esquerda; ?modelo=wap-w90 NAO serve NENHUMA das cinco — a recusa vale em producao e nao so na bancada; e a pagina passou a servir 'Em 11 dos 33 modelos' onde servia 13. REDE (20.2) remedida hoje as 15h17Z: robometria.com.br em 200 na home e no /status; wap.ind.br, loja.wap.ind.br e blog.wap.ind.br em 000 por connect_rejected (politica de egresso) na mesma passada, e o WebFetch de loja.wap.ind.br devolveu EGRESS_BLOCKED — por isso a coleta inteira saiu por busca restrita e todas as fontes desta leva sao nivel 4. DESCOBERTA DE PROCESSO QUE VALE PARA A PROXIMA COLETA: blog.wap.ind.br e onde a WAP nomeia a FUNCAO das pecas, por modelo; a loja nunca faz isso. Ate hoje so wap.ind.br, loja.wap.ind.br e mais.conteudo.wap.ind.br tinham sido testados. BANCO: 38 modelos (33 publicaveis), 32 pecas (29 publicaveis), 59 pares. Pauta da secao 17: pauta.md ainda nao existe — 0 escritos, 0 na fila, 0 recusados. ABERTO E NOMEADO, com um item NOVO e grave no topo: (a) A ILHA NAO CUMPRE A SECAO 25.2 DO CONTRATO, escrita em 13/09: 'todo item ganha url_busca ANTES de qualquer outra coisa; item sem url_busca e defeito da 19.1, sempre'. MEDIDO: url_busca nao existe em NENHUM arquivo do banco desta ilha, e sao 62 itens publicaveis (33 modelos + 29 pecas) sem piso de monetizacao — a ilha esta no ar com 'link de loja em breve' em todo cartao. Nao foi consertado aqui porque e esquema + dois geradores + snippet, com portao proprio, e nao cabe na cauda de um bloco de coleta; e o maior buraco nomeado desta ilha hoje. (b) A FRASE DA TELA ATRIBUI AO FABRICANTE A FUNCAO QUE A ILHA DERIVOU — 'A WAP declara a escova lateral "Escova Direita..."' esta certo quando a funcao veio do titulo e empresta autoridade quando veio do contraste (3 das 8 escovas). O defeito e ANTERIOR a este bloco, ja estava no ar nas duas Xiaomi 'Brush'; o que mudou e que agora ele e MENSURAVEL, porque declarada_por existe. Esta escrito na secao 26.3 do contrato. (c) o reenvio do sitemap no Search Console, metade humana do despacho de 10/09, segue travando a leva de malha 5b. PROXIMO, com ordem e motivo: (1) A FRASE DA R1 LENDO declarada_por, que e o item (b) — e o unico defeito de precisao no ar, o dado para conserta-lo nasceu neste bloco e o conserto e de frase, nao de coleta; (2) O PISO DA 25.2, o item (a), que e o maior em valor e o maior em tamanho — se for escolhido, e o bloco inteiro; (3) o RECIPIENTE DE PO do W300 e do WSMART, a coleta mais barata que existe hoje: a pagina ja esta localizada e o tipo 'reservatorio' e o unico do vocabulario com ZERO peca, entao a primeira devolve o tipo ao seletor da R1 de graca; (4) W90 Perola, W96, W3000, W4000, W2000 e WConnect, localizados e nao gravados por falta de duas passadas limpas proprias; (5) o S10 e o Mop 2 seguem sendo os dois Xiaomi vazios."
