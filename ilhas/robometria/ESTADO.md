...
estado: nascendo
prioridade: 1
ultima_execucao: 2026-09-11T21:48Z
executando_desde: 2026-09-11T23:16Z
bloco_atual: "A VOZ CHEGOU AS NOVE PAGINAS E O NOME DELAS PASSOU A TER UMA FONTE SO (casca 1.4.0, R1 1.2.0, R2 1.1.0, A1 1.1.0, A2 1.1.0, manifest revisao 17, /status conferido as 21h48Z). Fecha a 15.5 nesta ilha, sem criar URL. SEIS DAS NOVE PAGINAS TINHAM DOIS NOMES: o og:title publicava 'Quem publica a Robometria' e o H1 da mesma pagina dizia 'Sobre'; o artigo do filtro universal se chamava de dois jeitos a uma dobra de distancia. A casca 1.2.0 criou um mapa de cabecas com titulo proprio ao lado do titulo da definicao da pagina — dois mapas digitados, cada um certo no seu lugar, nenhum capaz de corrigir o outro. Agora robometria_casca_nome_da_pagina() e a fonte unica e o H1, o <title>, o og:title, o degrau da trilha e o rotulo do cartao derivam dela. O <title> ERA A UNICA SUPERFICIE QUE O REPOSITORIO NAO ESCREVIA: a home servia 'Robometria - Compatibilidade de pecas e dimensionamento de robo aspirador', 73 caracteres vindos do campo de descricao curta do wp-admin, um terceiro nome em vocabulario de dentro da fabrica que nenhuma bancada podia ver. A casca assumiu document_title_parts e o teto de 65 caracteres passou a ser cobrado no NOME (52), antes de publicar. A BANCADA MEDIA TRES PAGINAS PELA METADE, quarta repeticao da mesma cicatriz: varrer-corpo.php nunca carregou as options que o Sync grava, entao pagina:a1 devolvia 1.118 caracteres de corpo, pagina:a2 1.107 e a metodologia servia o aviso de que a medicao nao chegou — os onze numeros que a ilha publica sobre si mesma nunca foram varridos. Os tres eram paginas VALIDAS, com cabecalho, rodape e prosa honesta, e por isso a falta passou em silencio dentro do varredor que existe para medir a entrada inteira. Conserto em tres partes: o varredor carrega as options; o aviso de 'estamos sem o banco' ganhou dono unico na casca e a marca rbm-sem-banco no markup, que nao muda nada na tela e existe so para a bancada dizer 'isto nao e a pagina'; e dois portoes reprovam o estado degradado. Depois disso os dois renderizadores medem a mesma pagina com 34 caracteres de diferenca, constante. O TITULO DO A1 AFIRMAVA UMA TESE QUE O BANCO PODE INVERTER — a abertura, a description do JSON-LD e o FAQPage tem duas formas derivadas e o titulo tinha uma so, digitada, que ia junto para o headline. Virou pergunta, e a regra ficou estrutural no teste. OS QUATRO SNIPPETS DE PAGINA NUNCA REESPELHAVAM O post_title (so a casca aprendeu, na 1.2.0): renomear teria trocado os campos derivados e deixado o H1 e o <title> do ar com o nome antigo. Corrigido nos quatro. De quebra, o manifest dizia R2 1.0.2 e a constante dizia 1.0.1. A VOZ: as quatro paginas da casca perderam o nome de gaveta e ficaram com o nome que a cabeca delas ja publicava desde 11/09 (nada inventado); as aberturas das oito paginas deixaram de comecar nomeando a si mesmas e a procedencia desceu um paragrafo para a camada de prova (rbm-prova), o que tirou 'Electrolux' da primeira linha do A2 sem tirar o numero. PORTAO NOVO: ferramentas/teste-voz.php, 155 afirmacoes, um processo por pagina, regua propria, proibidas lidas do VOZ.md e regua de procedencia lida do banco; a excecao por classe vem com a contrapartida de que a linha-mestra NUNCA pode ser bloco de prova, e os blocos marcados sao contados e impressos. VERIFICACAO: voz 155, casca 149, arvore 213, r1 90, a1 55, r2 86, a2 63, acentuacao 17, validar-banco aprovado, php -l limpo; 29 mutacoes deliberadas, 29 reprovadas — uma delas ficou INERTE no instante em que o titulo da home mudou, porque o alvo deixou de existir, e so mordeu depois de reescrita; mutacoes-arvore 18/18; 258 medicoes em Chromium nas nove paginas em 360/390/781/782/783/1200 com 0 px de rolagem. NO AR as 21h48Z: revisao 17 no /status e 65 afirmacoes medidas no HTML servido por ferramentas/conferir-no-ar.py, que nasceu nesta execucao com os nove enderecos e os nove nomes escritos literalmente dentro dele — 9 de 9 em 200, <title> = nome + marca dentro do teto (o maior tem 63), og:title = H1 = nome nas nove, nenhuma no estado degradado, zero &#038; dentro de <script>. 44 itens esperam link de afiliado (nao mudou; este bloco nao tocou catalogo). Pauta da secao 17: pauta.md ainda nao existe — 0 escritos, 0 na fila, 0 recusados. Proximo: sem criar URL, a vitrine de produto dentro do resultado da R2 (a R1 ja tem o bloco de compra; a R2 recomenda modelo e nao tem) e a transcricao da composicao dos kits, que abre porta de compra por dado. Tudo que cria URL espera o reenvio do sitemap no Search Console, que e do Raphael."
