...
estado: nascendo
prioridade: 1
ultima_execucao: 2026-09-11T15:48Z
executando_desde: 2026-09-11T19:18Z
bloco_atual: "VOZ E CABECA DE PAGINA ENTREGUES E NO AR (casca 1.2.0, manifest revisao 15, /status conferido). O despacho do Raphael de 11/09 (secao 15 do contrato) e os ITENS 1 E 2 do despacho da Sentinela do mesmo dia fechados no mesmo bloco, porque moram na mesma casca. (1) CABECA DE PAGINA: nenhuma das 9 paginas tinha <meta name=description> — a Sentinela mediu null nas nove, e sem plugin de SEO ninguem imprimia a tag (a unica descricao que existia ia so para dentro do JSON-LD do Organization). Agora um mapa slug -> {titulo, descricao, tipo} com og:type/title/description/url/site_name/locale, e NENHUMA DESCRIPTION CARREGA NUMERO: e texto digitado que ninguem rele e que nem aparece na tela para alguem estranhar, entao numero ali dentro seria a cicatriz do cartao que dizia zero, so que invisivel de dentro do site. Pagina que a casca nao conhece sai SEM description — frase generica de reserva publicaria o mesmo texto em endereco diferente, que e o defeito que a tag existe para nao ter. (2) O H1 DA RAIZ era a palavra Inicio, e o defeito POR TRAS dele era garantir_paginas() nunca ter sincronizado titulo: a pagina nascia com o titulo da definicao e ficava com ele para sempre, e foi assim que Inicio sobreviveu a tres versoes da casca. Agora sincroniza, sem tocar no post_name — nenhuma URL mudou. (3) A HOME ERA UM MANIFESTO e virou A FERRAMENTA (molde FERRAMENTA do VOZ.md): promessa numa linha, o seletor da R1 CHAMADO e servido no HTML (5 optgroups, 28 modelos), atalhos por tipo DERIVADOS do banco, e a confissao numerica de cobertura mudou-se para a metodologia, que e a pagina cujo produto e o rigor. Menu virou Pecas / Succao / Como conferimos; NAO virou Pecas/Modelos/Guias porque esses tres sao niveis da arvore da secao 16 e ainda nao existem como pagina — sairiam como <span>. (4) A FOLHA DO FORMULARIO ganhou dono unico, como a porta de compra: estava duplicada na R1 e na R2 e JA DIVERGIA (so a R2 estilizava input[type=number]), e com a home seriam tres copias. O QUE A TRAVA NOVA ACHOU SEM PROCURAR, e as tres ja estavam NO AR: /divulgacao-de-afiliados/ com 1.325 caracteres de corpo (pagina fina em dominio novo gastando orcamento de rastreamento) — ganhou conteudo real da ilha e foi a 2.767; a frase 'ainda nao ha nenhum link de afiliado no ar' DIGITADA, que virou contagem derivada de itens_publicaveis menos esperando_link; e a lista de recusa da pagina Sobre sem marcacao no markup, que agora e rbm-recusa com todo item ABRINDO por negacao. VERIFICACAO: teste-casca 133 (eram 64), r1 90, a1 53, r2 86, a2 62, acentuacao 16, validar-banco aprovado, php -l limpo. QUINZE MUTACOES deliberadas em ferramentas/mutacoes-cabeca-e-voz.py e DUAS PASSARAM na primeira rodada, as duas viradas em conserto: a regua de escassez casava 'mais vendido' e deixou passar 'a peca mais vendida da categoria' (genero e numero em portugues sao o buraco por onde a frase proibida entra inteira — passou a usar radical), e a mutacao de pagina fina cortava 409 caracteres de uma pagina com 522 de folga, que e mutacao que nao mede nada. Na segunda rodada, 15 de 15 reprovadas. A bancada da casca passou a CARREGAR AS OPTIONS do manifest, senao mediria a home servindo o aviso de 'seletor fora do ar', que e uma pagina valida — seria a terceira vez que esta ilha mede pela metade sem ver. Chromium em 360/390/782/1200 nas nove paginas: 0 px de rolagem em 36 medicoes. NO AR as 15h47Z: 9 de 9 em 200, 9 de 9 com description de 116 a 136 caracteres e todas diferentes, og completo nas nove, zero &#038; dentro de <script> nas nove, o H1 da raiz nomeando os dois eixos da ilha, e o formulario servido na home. 44 itens esperando link (nao mudou; este bloco nao tocou em catalogo). NAO ENTROU DE PROPOSITO: a arvore da secao 16 (pai, breadcrumb, cluster, 301) e bloco proprio, e o defeito latente de robometria_casca_numeros() lendo option de publicar=false continua latente — a home deixou de depender dele, a metodologia ainda nao. Proximo: a ARVORE da secao 16 (ARVORE.md, pai de toda pagina, breadcrumb com BreadcrumbList, 'Veja tambem'), e junto dela derivar para casca-fatos.json os cinco numeros da secao 4 da metodologia"
