...
estado: nascendo
prioridade: 1
ultima_execucao: 2026-09-09T17:18Z
executando_desde: 2026-09-09T19:17Z
bloco_atual: "2"
bloqueada_por: null
---
...
Nada. A falta de WordPress **não** é bloqueio: os blocos 1 (feito), 2
(especificação das ferramentas) e 3 (modelo do banco) são de pesquisa e
modelagem e rodam sem infraestrutura. Por isso `bloqueada_por` continua
`null`.
