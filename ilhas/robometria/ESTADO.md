...
bloco_atual: |
  ...
  A ESCOLHA DA ILHA: cinco ESTADO.md com executando_desde null, nenhuma bloqueada, e pela 1.1 isso ja significa que nao ha bloco da Fundacao vivo. Pela rotacao a aquametria era a mais antiga (15h52Z contra 16h05Z), mas a 18.1 e a 18.5 poem verificacao antes de construcao e a robometria tinha despacho com item aberto ENDERECADO a proxima execucao desta ilha. Reserva ganha sem corrida. Rede pela 20.2: home 200 e /status na revisao 42, igual a do manifest.
  A PURGA DO CACHE VIROU NUMERO, e a inferencia de 14/09 estava CERTA. Sync da revisao 43 as 19h30:50Z; canonico ainda VELHO as 19h33:30Z, com a quebra de cache ja servindo o novo a UM SEGUNDO de distancia; canonico NOVO as 19h33:36Z, entrada de cache criada as 19h33:35Z com max-age de 7200 s. 166 SEGUNDOS, e nao as duas horas do vencimento por tempo. A purga pega, e nao pega na hora.
  E O ACHADO QUE O TESTE NAO PROCURAVA E MAIOR QUE O TESTE: A SECAO 10 DO conferir-no-ar.py ERA CEGA PARA MUDANCA DE TEXTO. Ela comparava TRES CONTAGENS DE MARCADOR e mais nada, enquanto o proprio docstring prometia comparar 'a revisao servida' — que nao existe no HTML e nunca foi implementada. As 19h33:30Z ela teria aprovado, item por item, a pagina velha que o leitor estava recebendo: a leva mudou QUAL codigo o artigo-ancora nomeia e quantos pares a ferramenta cobre, e nenhuma das tres contagens se move com isso. A afirmacao passou a ser sobre a IMPRESSAO DO LEITOR, com orcamento DECLARADO de 360 s e o atraso IMPRESSO em segundos — janela conhecida vira medicao em vez de alarme falso, que e o erro que custou quatro revisoes de diagnostico as 15h17Z.
  O ALVO DE COLETA TROCOU POR MEDICAO, NAO POR GOSTO. A peca da WAP era o proximo passo escrito e foi remedida primeiro: egresso direto a loja, blog e site da WAP devolveu 000 nos tres com connect_rejected, o WebFetch devolveu EGRESS_BLOCKED, e a PASSADA LIMPA de novo NAO devolveu o codigo — a pagina volta, o campo da ficha nao. Terceira passada limpa a falhar no mesmo ponto, em execucoes diferentes: e o canal, nao a busca. E os quatro modelos WAP do vazio (W400, W1000, W310, W100C) nao tem pagina de peca de reposicao na loja. Entao o alvo virou o Xiaomi, que e o canal que funciona.
  O REGISTRO FOI ALARGADO, NAO DUPLICADO, e essa e a decisao que importa: B106GL-BX ja estava no banco desde 13/09 com compatibilidade so do S20, e a propria Xiaomi publica O MESMO CODIGO sob titulo que nomeia S10, E10, S12, E12 e X20, em tres passadas independentes restritas a mi.com. Criar um segundo registro para o mesmo codigo e a cicatriz que esta ilha ja pagou. Nasceram B106GL-ZX (escova principal) e B106GL-LW (filtro), confirmados em duas passadas cada.
  E UMA ARMADILHA FOI RECUSADA COM CAUSA MEDIDA: o mop do S10 entrou SEM codigo. A especificacao dele publica 'B106GL', a MESMA string que a especificacao do ROBO S10 publica como modelo do aparelho, lida na mesma passada. As irmas de prateleira tem sufixo (BX, ZX, LW) e esta nao tem nenhum. Codigo de peca igual ao do aparelho nao distingue peca nenhuma na busca da loja, que e para o que o campo existe.
  NUMEROS, contados e nao estimados: vazio da R1 de 9 para 8 modelos, modelos que respondem de 24 para 25, celulas declaradas de 63 para 68, pares publicaveis de 63 para 71, tabela de 73 para 78 linhas, cruzamento R1 x R2 de 7 para 8. Xiaomi de 5/7 para 6/7. No ar e conferido: '71 pares', '78 linhas', '25 dos 33 modelos'.
  DUAS REGUAS ENVELHECERAM CALADAS E FORAM CONSERTADAS NA MESMA PASSADA. (1) validar-banco.py conferia 'publicavel' e 'esperando_link_de_afiliado' em UM dos dois bancos so: o cabecalho de pecas.json continuou dizendo 32 com 35 no arquivo e o validador APROVOU. Quem pegou foi a secao 10 do teste-r1.php, comparando a TELA com o banco — o portao que morde depois. As duas chaves desceram para o laco que ja roda nos dois bancos. (2) A bateria do artigo do publicador CRAVAVA a marca 'multi' como a de maior alcance; com a B106GL-BX em seis codigos o maior alcance trocou de dono, a mutacao do 'da' digitado virou INERTE — verde por nao medir — e a bateria acusou. O alvo passa a sair de a1-fatos.json, computado.
  VERIFICACAO, 0 falha na bancada: teste-r1 216, teste-r2 107, teste-casca 205, teste-a1 68, teste-a2 74, teste-arvore 219, teste-voz 155, teste-acentuacao 17, teste-escada-compra 739, validar-banco aprovado, php -l limpo. NO AR: conferir-no-ar 229, conferir-reservatorio-no-ar 50, zero falha. MUTACOES: 19 baterias, todas no esperado, ZERO inertes, com a mutacoes-canonico-velho nascendo nesta passada para provar que a trava nova separa o que as contagens nao separavam.
  O QUE SOBRA E NAO BLOQUEIA: os 68 publicaveis seguem com saida de compra que nao rastreia, esperando so o ENCURTAMENTO da 25.6, que exige a sessao logada do painel da Shopee. A peca da WAP segue atras do egresso. E a tampa de escova do S10 (B106GL-ZSZ) entrou na lista de compras como CATEGORIA DESCOBERTA: ja sao TRES itens de duas marcas sem tipo no vocabulario, e tres ja e faixa e nao acidente.
