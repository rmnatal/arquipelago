...
ultima_execucao: 2026-09-18T10:32Z
executando_desde: 2026-09-18T13:18Z   # reserva desta execucao pelo foco da 1.2
bloco_atual: |
  META DO ITEM 2 DA DEFINICAO DE PRONTA ATINGIDA: A INTERSECAO DAS DUAS FERRAMENTAS FOI DE 11 PARA 15, E O TETO DE 13 PARA 17. Entraram QUATRO modelos Roborock com os TRES campos que a intersecao conta — Qrevo Master (10.000 Pa), S8 MaxV Ultra (10.000), Qrevo Curv Series (18.500) e Saros Z70 (22.000) —, todos com canal brasileiro e peca declarada pelo fabricante. Banco de 45 para 50 modelos e de 49 para 53 pecas, 87 pares, 45 modelos e 50 pecas publicaveis. ZERO URL nova, ZERO URL mudada de endereco. Manifest na revisao 65, casca 1.10.1.
  A ESCOLHA DA ILHA: PELO FOCO DA 1.2, SEM CORRIDA. foco.md nomeia robometria desde 16/09. executando_desde estava null, que pela 1.1 ja significa que nenhum bloco da Fundacao esta vivo. Nenhum branch claude fora do main com commit proprio e nenhum PR aberto. Reserva aceita de primeira as 10h16Z. Rede pela 20.2 antes de trabalhar: home 200 e /status na revisao 64, igual a do manifest, em TRES passadas.
  O CANAL BRASILEIRO DA ROBOROCK ESTA VARRIDO INTEIRO E NAO PRECISA SER REPROCURADO: ele publica SEIS robos — Q8 Max, Qrevo Master, Qrevo Curv Series, S8 MaxV Ultra, Saros 10R e Saros Z70 — e os seis estao no banco. O Q7 Max, que o registro de 17/09 apontava como alvo, NAO EXISTE nesse canal. O F25 Combo Series existe e e aspirador umido-seco, nao robo. O egresso direto continua fechado (000, connect_rejected, em br.roborock.com e us.roborock.com, com a ilha em 200 na mesma janela); o canal que funcionou foi o mesmo de 17/09, a BUSCA restrita ao dominio do fabricante.
  O SAROS 10R ENTROU SEM Pa E DE PROPOSITO. TRES passadas, uma delas pedindo o valor em Pa com todas as letras, devolveram sempre 'potencia de succao lider do setor' sem numero. E recusa editorial do fabricante NESTE modelo — as outras cinco paginas da mesma marca declaram o numero —, e nao lacuna de coleta. Sem Pa ele nao e recomendavel pela R2, entao nao conta na intersecao nem no teto; entra porque a R1 responde por ele. NAO CONFUNDIR com o 'Saros 10', que e outro aparelho e nao esta no banco.
  O S8 MaxV ULTRA QUASE NAO ENTROU, E O MOTIVO E A SECAO 26. A unica peca que o nomeava em titulo indexado era o 'Cleaning Brush*2pcs', que nao e nenhum dos sete tipos desta ilha — forcar 'escova principal' ou 'escova lateral' nele seria ler FUNCAO do NOME, que e o que a 26 proibe. O que o fez entrar foi o 'Edgewise Mop Cloth*2pcs for S8 MaxV Ultra, S8 Max Ultra', que veio na LISTA DE RESULTADOS de uma passada cuja consulta NAO nomeava modelo nenhum.
  O ACHADO DO BLOCO E UM DEFEITO LATENTE PRE-EXISTENTE, E QUEM O PEGOU FOI A BANCADA. acentuar-banco.py acentuava UM LADO de uma chave de juncao: 'publicador', dentro de fontes, casa com o 'nome' de publicadores.json, e esse arquivo estava FORA da lista de arquivos do programa. Uma passada dele bastava para 'Electrolux (pagina institucional do produto)' ganhar acento no banco e nao aqui, e o validar-banco.py passava a REPROVAR o banco inteiro. Medido rodando o programa sobre o main INTOCADO, o que prova que o defeito nao veio desta leva. Quem acusou foram mutacoes-escada.py e mutacoes-artigo-do-publicador.py, as duas reprovando o MUNDO SADIO — que e exatamente o caso que essas baterias existem para pegar. publicadores.json entrou na lista e os dois lados passaram a andar juntos.
  A LICAO, E ELA NAO E SO DESTA ILHA: quem reescreve string tem de saber quais strings sao CHAVE. Chave se move nos dois lados no mesmo commit, ou nao se move.
  BANCADA, 0 falha: casca 251, r1 227, a1 74, r2 107, a2 80, acentuacao 17, arvore 219, voz 164, purga-cache 21, escada-compra 916, validar-banco aprovado, e as 26 baterias de mutacao sem nenhum ERRO. NO AR: Sync as 10h32Z, /status na revisao 65 igual a do manifest, conferir-no-ar 264 afirmacoes, conferir-kits-no-ar 165, conferir-reservatorio-no-ar 50, conferir-atribuicao-no-ar 51 e conferir-canal-na-resposta — todos 0 falha. O <title> derivado da R2 se reescreveu sozinho de 'de 1.400 a 10.000 Pa' para 'de 1.400 a 22.000 Pa ... nos 17 modelos', lido no HTML servido.
