...
ultima_execucao: 2026-09-12T17:25Z
executando_desde: 2026-09-12T19:18Z
bloco_atual: "A ILHA PASSA A SER MEDIDA — despacho do GA4 cumprido na parte desta ilha (casca 1.5.0, manifest revisao 21, /status conferido as 17h23Z em UM disparo). MARCO ZERO DA SERIE DE AUDIENCIA: 12/09/2026 17h23Z. Antes disso nao havia tag: toda leitura anterior mede a ausencia dela, nunca a ausencia de visita. O QUE ENTROU: a tag do GA4 pela CASCA, nunca por plugin (secao 11.7) — a pagina publica e territorio deste repositorio, e plugin de medicao seria um segundo dono do <head> que ninguem versiona. O ID e constante do topo (ROBOMETRIA_CASCA_GA4 = G-RM7KS75QP2) com o nome da ilha ao lado, e a razao nao e estilo: e a unica coisa que muda de ilha para ilha nesta secao, e ID digitado no meio de uma funcao e o que faz a casca copiada nascer medindo a propriedade da anterior. PRIORIDADE 23, porque o despacho pede a tag cedo E proibe que ela venha antes do <title> (1), da description (4) ou do JSON-LD (6, 7 e 22) — 23 e o primeiro degrau livre acima de todos. Script de terceiro com async, endereco com UM parametro so de proposito (um segundo traria & dentro de <script>, o defeito que derrubou cinco calculadoras da Aquametria), nenhum banner bloqueante. A LICAO DO BLOCO, E ELA VALE PARA A PROXIMA ILHA: O PORTAO MEDE ORDEM, NAO PRESENCA. "A tag esta na pagina" e a afirmacao facil e a que nao protege nada — um JSON-LD novo numa prioridade acima de 23 quebra a regra sem tirar a tag do lugar, e trava de presenca aprova isso com folga. Foi a quinta das nove mutacoes, e por causa dela o teste mede a posicao da tag contra o ULTIMO bloco application/ld+json SERVIDO. A SEGUNDA LICAO: o ID desta ilha esta ESCRITO na regua dos dois testes, nao lido da constante. Comparar a constante com o que a casca serviu e compara-la consigo mesma, e o unico erro que isso nunca pegaria e o que vai acontecer — esta casca foi copiada da Aquametria em 10/09, a proxima vai copiar esta, e o ID esquecido vai AO AR FUNCIONANDO, gravando sessao na propriedade errada por meses sem uma linha de defeito visivel. A FRASE DE PRIVACIDADE FOI PARA A PAGINA DE DIVULGACAO, e isso e item aberto de verdade: o despacho pedia a pagina de privacidade e ESTA ILHA NAO TEM UMA. Enquanto nao tiver, o lugar honesto e a pagina onde o site conta como funciona por dentro e que esta no rodape de todas; quando /privacidade/ nascer, a secao muda de casa. De quebra o corpo dela, que a ronda de 11/09 achou fino com 1.325 caracteres, cresceu e passou com folga. VERIFICACAO: teste-casca de 152 para 191 afirmacoes, 0 falha; mutacoes-ga4.py novo, 9 de 9 reprovadas, cada uma numa afirmacao diferente — e elas so foram aceitas com a bancada VERDE por baixo, porque na primeira rodada o manifest ainda dizia 1.4.1 contra a constante 1.5.0 e TODA mutacao reprovava tambem por isso: teste ja vermelho nao prova mutacao nenhuma. Regressao sem uma falha em teste-arvore (213), teste-voz (155), teste-r1 (90), teste-r2 (90), teste-a1 (55), teste-a2 (73), teste-acentuacao (17), validar-banco, php -l em tudo, e as quatro baterias antigas (18, 29, 11, 15) — nenhuma virou inerte. NO AR as 17h23Z: conferir-no-ar.py de 82 para 138 afirmacoes, 0 falha, com a tag conferida nas nove URLs (ID, async, gtag config, ordem contra o <title> e contra o ultimo JSON-LD, unico script de terceiro) e a frase da divulgacao medida no CORPO servido — no <head> a palavra googletagmanager aparece nas nove, e medir no HTML inteiro aprovaria uma pagina muda. As nove URLs em 200. A METADE QUE NAO E DAQUI, E NAO E DEFEITO: o despacho tambem declara pronto quando o Tempo Real do GA4 registrar a visita de verificacao, e este ambiente NAO TEM a credencial da conta de servico (ferramentas/ga4.py responde "Sem credencial: defina GOOGLE_SA_B64..."). O que esta medido daqui e a metade que estava quebrada: a tag certa, no lugar certo, no HTML servido. REDE reconferida (secao 20.2): dominio da ilha em 200 em duas passadas, mais Sync e /status; nenhum bloqueio. 44 itens esperando link de afiliado (nao mudou; este bloco nao tocou catalogo). Pauta da secao 17: pauta.md ainda nao existe — 0 escritos, 0 na fila, 0 recusados. PROXIMO: a secao 'Exatamente no limiar' da R2, ultimo lugar das duas ferramentas onde um numero decide e a origem nao aparece, com as pecas ja prontas; e junto dele o afiliado.sub_id_2 dos cinco itens da vitrine do A2, carimbados 'R2' porque o campo e do MODELO e as duas paginas o compartilham — no dia do primeiro link, todo clique do artigo seria contado como da ferramenta, e o conserto e cada gerador carimbar o proprio codigo, nunca trocar o valor no banco. Kits e 3c parados por rede. Tudo que cria URL espera o reenvio do sitemap no Search Console, que e do Raphael."
