...
ultima_execucao: 2026-09-13T17:22Z
executando_desde: 2026-09-13T19:35Z
bloco_atual: "A FRASE DA R1 DEVOLVE A FUNCAO A QUEM A LEU (r1 1.3.0, manifest revisao 29, /status conferido as 17h32Z em UM disparo; nenhuma URL nova, nenhuma peca entrou ou saiu do banco, nenhum snippet alem da R1 tocado). Era o item (b) que a execucao das 15h32Z deixou nomeado, e o unico defeito de precisao que a ilha tinha no ar. A R1 publicava em cinco pecas 'A WAP declara A ESCOVA LATERAL "Escova Direita Para Robo Aspirador de Po Robot W300"' — e a WAP nunca usou a palavra lateral: ela batiza pela POSICAO (Direita, Esquerda, Central, Frontal) e o vocabulario desta ilha classifica pela FUNCAO. Quem leu a funcao no contraste do catalogo dela foi a Robometria, e a frase emprestava ao fabricante a unica coisa que esta ilha vende, que e a declaracao dele. A Xiaomi e o caso extremo: o titulo dela e so "Brush" e nao nomeia nem posicao. O CONSERTO E DE MOLDE, NAO DE REMENDO: onde funcao.declarada_por nao e titulo, o verbo "declara" passa a recair sobre o que o fabricante DE FATO declarou — o nome da peca e a lista de modelos — e a atribuicao da funcao vira ressalva propria, ao lado das que a frase ja tinha. A tela serve agora 'Escova lateral: "Escova Direita ...", que a WAP (loja oficial) declara compativel com W300 (loja oficial da marca, verificado em 13/09/2026). Quem chama esta peca de escova lateral e a Robometria, pelo contraste do catalogo do proprio fabricante: o titulo dela nao nomeia a funcao.' O tipo continua ABRINDO a frase, porque a regua 14 mede a primeira oracao e e ali que o leitor descobre de que peca se fala. ONDE O TITULO DECLARA A FUNCAO NADA MUDOU (Multi, Positivo, Electrolux, a Side Brush da Xiaomi): a atribuicao e verdadeira e e a frase mais forte que a ilha tem. A RESSALVA SO FICOU HONESTA NA SEGUNDA VERSAO: a primeira dizia "o titulo dela nomeia a posicao, nao a funcao", verdade na WAP e FALSA na Xiaomi — afirmacao em bloco tem o escopo do que foi medido, e o que vale nos dois e mais curto, o titulo NAO NOMEIA a funcao. POR QUE NENHUM PORTAO VIA O DEFEITO, e este e o achado de processo: todos comparavam a frase do PHP com a da referencia, e AS DUAS DIZIAM A MESMA COISA ERRADA. Duas metades que erram juntas ficam verdes. O portao 15 novo do teste-r1.php nao chama robometria_r1_funcao_derivada() nem le o campo funcao_declarada_por de r1-respostas.json — os dois sao produto de quem escreve a frase: ele reabre pecas.json e o esquema, recomputa quem e derivada e cobra as DUAS implementacoes. E COBRA OS DOIS LADOS, porque proibir a atribuicao na peca derivada sozinho seria atendido por uma frase que nunca atribui nada a ninguem. A PRIMEIRA VERSAO DA REGUA TINHA UM BURACO E QUEM O MOSTROU FOI A MUTACAO: ela procurava so "Quem chama esta peca de", e a mutacao que faz a ressalva sair em TODA peca escapava, porque com declarada_por=titulo o PHP cai no aviso de origem desconhecida, que comeca com outras palavras. Quem proibe um texto proibe as formas que o CODIGO consegue produzir, nao a que veio a cabeca de quem escreveu a regua. O RAMO DEFENSIVO DO SNIPPET PASSOU A SER MEDIDO — ele existe porque o Sync entrega dado e codigo em requisicoes separadas e um r1-respostas.json com origem nova pode chegar ANTES do snippet que sabe explica-la; o mundo e produzido no ITEM, porque o validador impede o banco de gravar origem fora do vocabulario. AS TRES MUTACOES QUE PRODUZEM O MUNDO: o esquema permite canal-de-manutencao e o banco NAO TEM NENHUMA PECA ASSIM, entao elas criam a peca que nao existe e so depois quebram a regra nela; a decima e o mesmo mundo INTACTO e TEM de passar, senao a regua seria falso-positivo esperando a primeira peca de manual entrar no banco. VERIFICACAO NA BANCADA, 0 falha: teste-r1 106 medicoes (era 96), casca 200, a1 56, r2 92, a2 73, voz 155, acentuacao 17, arvore 213, validar-banco APROVADO, php -l limpo. MUTACOES: 126 em 12 baterias, 125 reprovadas e 1 aprovada de proposito, 0 INERTES — as 116 antigas rodadas inteiras para provar que nenhuma morreu com o molde novo. NAVEGADOR: 258 medicoes em 9 paginas x 6 larguras, 0 px de rolagem, console limpo. NO AR as 17h32Z em UM disparo: /status na revisao 29 igual a do manifest, 10 aplicados; conferir-no-ar 149 e conferir-kits-no-ar 163 rodados DEPOIS do Sync, 0 falha; e a medicao que so o ar podia fazer NASCEU COMO ARQUIVO COMMITADO, ferramentas/conferir-atribuicao-no-ar.py, 19 afirmacoes e 0 falha — as cinco pecas derivadas com a ressalva servida e nenhuma atribuicao ao fabricante no CORPO, e o electrolux-erb60 do outro lado com a atribuicao de titulo intacta. Ela imprime o tamanho da pagina medida (132 a 136 KB) e tira o modelo de cada peca do gabarito, nunca digitado. UMA AFIRMACAO QUE A REGUA NAO PODE FAZER, e esta escrita nela: "nada atribui X ao fabricante" so e cobrada no modelo em que TODAS as pecas daquele tipo sao derivadas — num modelo misto a frase proibida seria a frase CERTA da peca vizinha. REDE (20.2) remedida no comeco desta execucao: robometria.com.br em 200 na home e no /status. BANCO SEM MUDANCA: 38 modelos (33 publicaveis), 32 pecas (29 publicaveis), 59 pares. Pauta da secao 17: pauta.md ainda nao existe — 0 escritos, 0 na fila, 0 recusados. ABERTO E NOMEADO: (a) A ILHA CONTINUA SEM CUMPRIR A SECAO 25.2 — url_busca nao existe em NENHUM arquivo do banco, sao 62 itens publicaveis (33 modelos + 29 pecas) sem piso de monetizacao, com a ilha no ar dizendo "link de loja em breve" em todo cartao; e o maior buraco desta ilha e agora nao tem mais nada na frente. (b) FECHADO POR ESTE BLOCO. (c) o reenvio do sitemap no Search Console, metade humana do despacho de 10/09, segue travando a leva de malha 5b. (d) 23 arquivos seguem fora do manifest e o atualizar-manifest.py avisa e SEGUE — os dois portoes novos deste bloco ENTRARAM no manifest, entao a divida nao cresceu com ele. PROXIMO, com ordem e motivo: (1) O PISO DA 25.2, o item (a): esquema + dois geradores + snippet, com portao proprio, e bloco inteiro; era o (2) da ordem anterior so porque este conserto de frase estava na frente. (2) o RECIPIENTE DE PO do W300 e do WSMART, a coleta mais barata que existe hoje — a pagina ja esta localizada e reservatorio e o unico tipo do vocabulario com ZERO peca, entao a primeira devolve o tipo ao seletor da R1 de graca. (3) W90 Perola, W96, W3000, W4000, W2000 e WConnect, localizados e nao gravados por falta de duas passadas limpas proprias. (4) o S10 e o Mop 2 seguem sendo os dois Xiaomi vazios."
