...
ultima_execucao: 2026-09-12T21:16Z
executando_desde: 2026-09-12T23:18Z
bloco_atual: "A COMPOSICAO DOS KITS DO ERB30 E DO ERB44 TRANSCRITA, e o ERB30 sai do vazio (manifest revisao 23, /status conferido as 21h29Z em UM disparo; nenhuma URL nova, nenhum snippet tocado — mudou o BANCO e, com ele, cinco arquivos de dados publicaveis). A REDE DE FABRICANTE SEGUE FECHADA E O CANAL DE BUSCA NAO, e essa distincao nunca tinha sido testada nesta ilha: reconferido como a 20.2 manda, em duas passadas, a ilha em 200 e electrolux.com.br, loja.electrolux.com.br, mi.com.br e mais.conteudo.wap.ind.br em 000 por politica de egresso, com WebFetch devolvendo EGRESS_BLOCKED — mas a BUSCA alcanca a Electrolux, e era por ela que os dois kits esperavam desde 09/09. ERB30: composicao completa, com as quantidades da propria pagina do kit (01 filtro HEPA, 01 pano de microfibra, 02 escovas de varredura de cantos), pedida DUAS vezes com perguntas diferentes e sem o valor dentro da consulta. Era a UNICA peca que servia o ERB30, e kit fechado e o estado em que a R1 sabe que ha um kit e nao sabe o que vem dentro — o modelo nao respondia consulta nenhuma. ERB44: composicao PELA METADE, de proposito — a pagina declara os tipos e nao as quantidades, e chama a escova de 'escovas' sem dizer se e a de cantos ou a rotativa central (que o ERB44 vende a parte); filtro e mop entram confirmados, a escova entra com tipo null. A BUSCA OFERECEU A COMPOSICAO DO ERB30 COMO PREENCHIMENTO E ELA FOI RECUSADA: modelo vizinho nao declara pelo vizinho. MEDIDO: celulas declaradas 41 -> 45, os 11 cruzamentos em 'kit sem composicao' foram a ZERO, a R1 responde em 16 dos 28 modelos (era 15) e a Electrolux passa a 9/9; sete celulas mudaram de 'ha um kit e nao sabemos' para VAZIA DECLARADA, que e mais honesto e nao menos. A RECARGA (item (e) do 3c) MUDOU DE NATUREZA E NAO E MAIS COLETA, igual ao que aconteceu com os m2 no item (d): nenhuma pagina de modelo declara tempo de carga, e o unico numero publicado esta num artigo de FAMILIA da Electrolux (24 h na primeira carga, 5 h nas seguintes) que, NA MESMA FRASE, declara autonomia de 90 minutos — e 90 min nao e a autonomia de nenhum dos cinco alvos (100, 100, 100, 100 e 120). O artigo fala de outro aparelho. A REGRA QUE FICA PARA TODA COLETA DESTA ILHA: quando um documento de familia traz DOIS numeros, o que voce ja conhece diz se o outro e do seu modelo — foi a declaracao vizinha que desmascarou a atribuicao. Os cinco motivo_do_null passaram de 'nao coletado ainda' para a causa medida, com o nome do documento. O DEFEITO QUE A PROPRIA TRANSCRICAO DESCOBRIU, verde havia blocos: os quatro lacos da secao 3 do teste-r1.php varriam so a lista da REFERENCIA e indexavam a do PHP pela chave dela — (1) peca a MAIS no lado do PHP nunca era comparada com nada, que numa ilha cujo produto e compatibilidade e o defeito mais caro que existe; (2) grupo vazio rodava zero vezes e dava verde, e foi a MINHA propria entrega que zerou 'kits_sem_composicao' em todos os modelos; (3) ao contar por grupo apareceu um segundo vazio que ninguem sabia — 'terceiro', que nunca mediu nada. Agora as chaves sao comparadas nos DOIS sentidos e grupo com zero aparece nomeado. VERIFICACAO: os oito portoes em 898 afirmacoes, 0 falha (teste-r1 de 90 para 93); php -l em tudo; validar-banco aprovado com os mesmos 2 avisos de variante. MUTACOES: mutacoes-chaves-da-r1.py novo, 4 de 4 reprovadas, e a de 'peca a mais' SO a trava nova pega — as outras tres foram escolhidas para passar pelo portao antigo de proposito. As seis baterias antigas rodadas inteiras, nenhuma inerte: 17, 18, 29, 9, 15 e 5. NO AR: conferir-kits-no-ar.py novo, 41 afirmacoes, 0 falha, varrendo 9 estados de ENTRADA (ERB30 x 5 tipos, ERB44 x 4) porque o conferir-no-ar.py mede as nove URLs no caso-ANCORA e este bloco mudou pagina que so existe quando alguem escolhe um modelo; conferir-no-ar.py tambem rodado, 149 afirmacoes, 0 falha. A LICAO DELE, e custou uma reprovacao: a primeira versao procurava 'nao localizamos' no CORPO e reprovou os cinco estados que RESPONDEM, porque a frase existe duas vezes na pagina por motivo legitimo (a promessa do topo e a secao que lista os 12 modelos sem resposta). Era a heuristica por vizinhanca que a secao 8 proibe, escrita por quem acabara de citar a secao 8 — QUEM DECIDE E A ESTRUTURA: o bloco vai de id=resultado ate rbm-quadro, e sem a fronteira a conferencia REPROVA em vez de aprovar por ausencia. NUMERO DE TELA NASCIDO CONTADO: a home e a R1 servem agora 'cobrindo 16 dos 28 modelos' sem ninguem digitar, e o ERB30 saiu da lista dos 12 que a pagina nomeia como sem resposta. 44 itens esperando link de afiliado (nao mudou; este bloco nao acrescentou item, so descreveu o que ja estava la). Pauta da secao 17: pauta.md ainda nao existe — 0 escritos, 0 na fila, 0 recusados. PROXIMO, com alvo e canal nomeados: (1) o KIT PERFORMANCE DO ERB80, que EXISTE na loja e NAO esta no banco (achado desta execucao) — o ERB80 so responde escova principal hoje, e o kit destravaria filtro e mop; ficou fora deste bloco de proposito porque e registro NOVO, nao transcricao, e as duas leituras devolveram so o trio generico, sem quantidade e sem o tipo da escova, entao ele entra no nivel do ERB44 e nao no do ERB30; (2) pecas da Xiaomi e da WAP com codigo, que a varredura aponta como o primeiro alvo entre os coletaveis (os 8 modelos que a R2 recomenda e a R1 deixa vazios) — se o canal de BUSCA alcanca mi.com nao foi testado, teste antes de escolher; (3) a leva de malha (5b) segue travada pela metade humana do despacho de 10/09, o reenvio do sitemap."
