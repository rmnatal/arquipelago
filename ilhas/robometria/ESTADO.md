...
estado: nascendo
prioridade: 1
ultima_execucao: 2026-09-11T19:47Z
executando_desde: 2026-09-11T21:19Z
bloco_atual: "A ARVORE DA SECAO 16 ESTA NO AR NAS NOVE PAGINAS (casca 1.3.0, manifest revisao 16, /status conferido as 19h47Z). Fecha o item que o despacho do Raphael de 11/09 deixou de pe depois do bloco da voz, e fecha SEM criar uma URL — que era a condicao para caber agora, porque esta ilha nao publica leva de malha enquanto o sitemap nao for reenviado no Search Console (metade humana do despacho da Sentinela de 10/09, e ela e do Raphael). (1) ARVORE.md novo: quatro secoes de nivel 1 (/pecas/, /succao/, /modelos/, /guias/), quatorze categorias de nivel 2 e o lugar de cada uma das nove paginas. O teste LE esse arquivo e cobra nas duas direcoes que documento e codigo digam a mesma coisa. (2) AS DUAS DECISOES QUE O DESPACHO MANDOU TOMAR: /metodologia/ fica na raiz (a lista da 16.1 nomeia a familia da pagina institucional, e a metodologia e dela; a Aquametria resolveu igual no mesmo dia); /ferramentas/ fica hoje como MAE DE TRANSICAO das duas ferramentas e sai com 301 para a home no dia em que /pecas/ e /succao/ nascerem, porque ai ela serviria a mesma listagem que elas, que a 14.4 proibe. Mae com endereco de verdade em vez de degrau em texto apontando para o vazio. O menu NAO virou Pecas/Modelos/Guias: sairiam como <span>. (3) TRILHA nas oito paginas que nao sao a home, sempre entre o cabecalho e o H1; BREADCRUMBLIST levando so os degraus com endereco — num guia a trilha mostra quatro degraus e o schema publica dois, de proposito, porque ListItem do meio sem item invalida a lista inteira e lista invalida e lista ignorada; VEJA TAMBEM com irmas DERIVADAS do mesmo registro que alimenta o hub, e a frase de mae com a contagem CONTADA. Cada mae tem duas filhas hoje, entao cada filha tem UMA irma e a 16.4(c) pede de 2 a 4: estado de transicao declarado, o minimo chega com a terceira filha. (4) O DEFEITO QUE A VARREDURA DE LINKS ACHOU SEM PROCURAR: a ferramenta de succao linkava o guia da OUTRA e nao o dela, o de metros quadrados por carga — o par da 16.4(d) aberto de um lado so, invisivel porque um link para guia havia e nenhum teste perguntava se era o guia CERTO. O portao agora deriva o par do catalogo de artigos e cobra os dois sentidos. (5) OS ONZE NUMEROS DA ILHA SAIRAM DO SNIPPET e o defeito latente disparou na leitura: robometria_casca_numeros() lia a option robometria_dados_cobertura-r1, e cobertura-r1 tem publicar=false — a option NUNCA existiu no site, entao no ar todo numero sempre veio do valor digitado e o caminho derivado era decoracao. Um ja mentia: 'pares peca x modelo, todos declarados' dizia 33 e o banco serve 32, porque o par que sobrava aponta para multi-ho401, que e nao_publicavel. Os dois numeros medem coisas diferentes e os dois ficam — o cabecalho conta o que o banco guarda, a tela conta o que o site responde —, e a pagina passou a dizer a regua em voz alta. Agora eles viajam em casca-fatos.json, publicavel, com reguas_da_medicao dentro do arquivo; o gerador RECUSA gravar se cobertura-r1.json nao bater com o banco de hoje, e sem o arquivo a pagina NAO inventa numero, diz que a medicao nao chegou. (6) O TESTE QUE COMPARAVA DUAS COPIAS DA MESMA REGUA: a secao 8 do teste-casca conferia o numero da tela contra contagem.publicavel e irmaos, campos escritos no proprio arquivo de banco — trocar a regra faria as duas metades errarem juntas. Passou a contar nos registros, e foi assim que o 33 apareceu. (7) A BANCADA VOLTOU A SERVIR O QUE O SITE SERVE, tres consertos e a mesma cicatriz: ela nao montava o bloco core/post-title (media paginas sem H1 nenhum, e a trilha nasce entre o cabecalho e o H1), nao rodava os filtros do the_content (o Veja tambem e a rede de seguranca da trilha seriam invisiveis) e o add_filter aceitava a prioridade e jogava fora. VERIFICACAO: teste-arvore 213 afirmacoes com um processo por pagina, teste-casca 135, r1 90, a1 53, r2 86, a2 62, acentuacao 16, validar-banco aprovado, php -l limpo. 18 mutacoes deliberadas, 18 reprovadas — TRES passaram na primeira rodada por serem INERTES (a guarda da home, a frase de mae e um corte de 345 caracteres numa pagina com 526 de folga) e foram reescritas ate morder. Chromium em 360/390/781/782/783/1200 nas nove paginas: 258 medicoes, 0 px de rolagem. NO AR as 19h47Z: 9 de 9 em 200, 94 afirmacoes medidas no HTML servido, zero &#038; dentro de <script> nas nove, trilha sempre antes do H1 e uma so por pagina, nenhum degrau apontando para pagina inexistente, e os numeros servindo 5 marcas, 28 modelos, 16 pecas, 32 pares, medicao de 11/09/2026. 44 itens esperando link de afiliado (nao mudou; este bloco nao tocou catalogo), nenhum com loja possivel hoje. Pauta da secao 17: pauta.md ainda nao existe nesta pasta — 0 escritos, 0 na fila, 0 recusados. ACHADO REGISTRADO, fora do escopo: /sobre/ e a unica das nove que nenhum CORPO de outra cita — vive do menu e do rodape, entao nao e orfa pelo 16.4(f), mas e a unica sem citacao editorial. A Aquametria achou o mesmo no mesmo dia, o que sugere molde de casca e nao ilha. E assunto de pauta. Proximo: a reescrita na voz das paginas restantes (15.5), que nao cria URL. Tudo que cria URL — as quatro secoes, as quatorze categorias, a troca de pai e slug — espera o reenvio do sitemap no Search Console."
