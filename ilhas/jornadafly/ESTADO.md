...
bloco_atual: |
  ...
  O DOMÍNIO JÁ ESTÁ PAGO desde 13/09/2026 — **o relógio do Google já corre.** Esta é a única ilha do arquipélago que nasceu sem esperar compra de domínio, então a infraestrutura da seção 11 pode começar hoje, em paralelo ao bloco 1.
bloqueada_por: null
---
...
## O que está travando
Nada. O domínio já existe, então a seção 11 pode andar em paralelo ao bloco 1.
